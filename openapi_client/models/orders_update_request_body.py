...
class OrdersUpdateRequestBody(BaseModel):
    """
    Request body schema for **PUT** `/orders/{orderId}`.  # noqa: E501
    """
    ...
    __properties = ["status", "amount", "discount_amount", "initial_amount", "items", "customer", "customer_id", "referrer", "referrer_id", "metadata"]
