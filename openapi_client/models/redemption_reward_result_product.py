...
class RedemptionRewardResultProduct(BaseModel):
    """
    Defines of the product.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRewardResultProduct:
        """Create an instance of RedemptionRewardResultProduct from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRewardResultProduct:
        """Create an instance of RedemptionRewardResultProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRewardResultProduct.parse_obj(obj)

        _obj = RedemptionRewardResultProduct.parse_obj({
            "id": obj.get("id"),
