...
class CampaignsGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `/campaigns/{campaignId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsGetResponseBody:
        """Create an instance of CampaignsGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsGetResponseBody:
        """Create an instance of CampaignsGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsGetResponseBody.parse_obj(obj)

        _obj = CampaignsGetResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
