...
class CampaignsUpdateLoyaltyCampaign(BaseModel):
    """
    ...
    options: Optional[PropertiesForLoyaltyCampaignOptions] = None
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "loyalty_tiers_expiration", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateLoyaltyCampaign:
        """Create an instance of CampaignsUpdateLoyaltyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateLoyaltyCampaign:
        """Create an instance of CampaignsUpdateLoyaltyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateLoyaltyCampaign.parse_obj(obj)

        _obj = CampaignsUpdateLoyaltyCampaign.parse_obj({
            ...
            "options": PropertiesForLoyaltyCampaignOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
