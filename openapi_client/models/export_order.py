...
class ExportOrder(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportOrder:
        """Create an instance of ExportOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportOrder:
        """Create an instance of ExportOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportOrder.parse_obj(obj)

        _obj = ExportOrder.parse_obj({
            "id": obj.get("id"),
