...
class EventCustomerShopifySent(BaseModel):
    """
    Event data object schema for `customer.shopify.sent`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerShopifySent:
        """Create an instance of EventCustomerShopifySent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerShopifySent:
        """Create an instance of EventCustomerShopifySent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerShopifySent.parse_obj(obj)

        _obj = EventCustomerShopifySent.parse_obj({
