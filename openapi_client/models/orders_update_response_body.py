...
class OrdersUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `/orders/{orderId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersUpdateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersUpdateResponseBody:
        """Create an instance of OrdersUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersUpdateResponseBody.parse_obj(obj)

        _obj = OrdersUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
