...
class ExportBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportBase:
        """Create an instance of ExportBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportBase:
        """Create an instance of ExportBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportBase.parse_obj(obj)

        _obj = ExportBase.parse_obj({
            "id": obj.get("id"),
