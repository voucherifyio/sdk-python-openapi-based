...
class RedemptionsRollbackCreateRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsRollbackCreateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsRollbackCreateRequestBody:
        """Create an instance of RedemptionsRollbackCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsRollbackCreateRequestBody.parse_obj(obj)

        _obj = RedemptionsRollbackCreateRequestBody.parse_obj({
