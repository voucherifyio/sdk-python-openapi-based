...
class ClientEventsCreateRequestBodyLoyalty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientEventsCreateRequestBodyLoyalty:
        """Create an instance of ClientEventsCreateRequestBodyLoyalty from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientEventsCreateRequestBodyLoyalty:
        """Create an instance of ClientEventsCreateRequestBodyLoyalty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientEventsCreateRequestBodyLoyalty.parse_obj(obj)

        _obj = ClientEventsCreateRequestBodyLoyalty.parse_obj({
            "code": obj.get("code")
        })
        return _obj
