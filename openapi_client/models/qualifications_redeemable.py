...
class QualificationsRedeemable(BaseModel):
    ...
    redeemables: Optional[conlist(QualificationsRedeemableBase)] = None
    __properties = ["id", "object", "created_at", "result", "order", "validation_rule_id", "applicable_to", "inapplicable_to", "metadata", "categories", "banner", "name", "campaign_name", "campaign_id", "validation_rules_assignments", "redeemables"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualificationsRedeemable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualificationsRedeemable:
        """Create an instance of QualificationsRedeemable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualificationsRedeemable.parse_obj(obj)

        _obj = QualificationsRedeemable.parse_obj({
            "id": obj.get("id"),
            ...
            "redeemables": [QualificationsRedeemableBase.from_dict(_item) for _item in obj.get("redeemables")] if obj.get("redeemables") is not None else None
        })
        return _obj
