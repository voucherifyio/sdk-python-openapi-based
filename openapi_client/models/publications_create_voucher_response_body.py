...
class PublicationsCreateVoucherResponseBody(BaseModel):
    """
    ...
    voucher: Voucher = Field(...)
    __properties = ["id", "object", "created_at", "customer_id", "tracking_id", "metadata", "channel", "source_id", "result", "customer", "vouchers_id", "voucher"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicationsCreateVoucherResponseBody:
        """Create an instance of PublicationsCreateVoucherResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicationsCreateVoucherResponseBody:
        """Create an instance of PublicationsCreateVoucherResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicationsCreateVoucherResponseBody.parse_obj(obj)

        _obj = PublicationsCreateVoucherResponseBody.parse_obj({
            "id": obj.get("id"),
