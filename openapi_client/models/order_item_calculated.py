...
class OrderItemCalculated(BaseModel):
    ...
    __properties = ["sku_id", "product_id", "related_object", "source_id", "quantity", "discount_quantity", "initial_quantity", "amount", "discount_amount", "initial_amount", "total_applied_discount_amount", "price", "subtotal_amount", "product", "sku", "object", "metadata"]
