...
class OrderCalculatedBase(BaseModel):
    """
    ...
    __properties = ["id", "source_id", "created_at", "updated_at", "status", "amount", "initial_amount", "discount_amount", "items_discount_amount", "total_discount_amount", "total_amount", "applied_discount_amount", "items_applied_discount_amount", "total_applied_discount_amount", "items", "metadata", "customer_id", "referrer_id", "object", "redemptions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCalculatedBase:
        """Create an instance of OrderCalculatedBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCalculatedBase:
        """Create an instance of OrderCalculatedBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCalculatedBase.parse_obj(obj)

        _obj = OrderCalculatedBase.parse_obj({
            "id": obj.get("id"),
