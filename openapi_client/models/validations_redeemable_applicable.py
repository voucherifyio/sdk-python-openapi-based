...
class ValidationsRedeemableApplicable(BaseModel):
    """
    ValidationsRedeemableApplicable
    """
    status: Optional[StrictStr] = Field('APPLICABLE', description="Indicates whether the redeemable can be applied or not applied based on the validation rules.")
    ...
    result: Optional[ValidationsRedeemableApplicableResult] = None
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('APPLICABLE',):
            raise ValueError("must be one of enum values ('APPLICABLE')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationsRedeemableApplicable:
        """Create an instance of ValidationsRedeemableApplicable from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationsRedeemableApplicable:
        """Create an instance of ValidationsRedeemableApplicable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationsRedeemableApplicable.parse_obj(obj)

        _obj = ValidationsRedeemableApplicable.parse_obj({
            "status": obj.get("status") if obj.get("status") is not None else 'APPLICABLE',
            "id": obj.get("id"),
            ...
            "result": ValidationsRedeemableApplicableResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
