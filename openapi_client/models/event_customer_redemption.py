...
class EventCustomerRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRedemption:
        """Create an instance of EventCustomerRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRedemption:
        """Create an instance of EventCustomerRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRedemption.parse_obj(obj)

        _obj = EventCustomerRedemption.parse_obj({
