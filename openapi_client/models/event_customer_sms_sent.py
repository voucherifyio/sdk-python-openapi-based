...
class EventCustomerSmsSent(BaseModel):
    """
    Event data object schema for `customer.sms.sent`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerSmsSent:
        """Create an instance of EventCustomerSmsSent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerSmsSent:
        """Create an instance of EventCustomerSmsSent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerSmsSent.parse_obj(obj)

        _obj = EventCustomerSmsSent.parse_obj({
