...
class ValidationRuleBase(BaseModel):
    """
    This is an object representing a request validation rule.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRuleBase:
        """Create an instance of ValidationRuleBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRuleBase:
        """Create an instance of ValidationRuleBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRuleBase.parse_obj(obj)

        _obj = ValidationRuleBase.parse_obj({
            "name": obj.get("name"),
            "rules": obj.get("rules"),
