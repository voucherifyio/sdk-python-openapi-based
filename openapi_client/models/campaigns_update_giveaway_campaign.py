...
class CampaignsUpdateGiveawayCampaign(BaseModel):
    """
    ...
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "winners_count", "unique_winners_per_draw", "unique_winners"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateGiveawayCampaign:
        """Create an instance of CampaignsUpdateGiveawayCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateGiveawayCampaign:
        """Create an instance of CampaignsUpdateGiveawayCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateGiveawayCampaign.parse_obj(obj)

        _obj = CampaignsUpdateGiveawayCampaign.parse_obj({
