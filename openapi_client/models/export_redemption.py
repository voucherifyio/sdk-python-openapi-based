...
class ExportRedemption(BaseModel):
    """
    ExportRedemption
    """
    ...
    parameters: Optional[ExportRedemptionBaseParameters] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportRedemption:
        """Create an instance of ExportRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportRedemption:
        """Create an instance of ExportRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportRedemption.parse_obj(obj)

        _obj = ExportRedemption.parse_obj({
            "id": obj.get("id"),
            ...
            "exported_object": obj.get("exported_object") if obj.get("exported_object") is not None else 'redemption',
            "parameters": ExportRedemptionBaseParameters.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None
        })
        return _obj
