...
class RedemptionRelatedRedemptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRelatedRedemptions:
        """Create an instance of RedemptionRelatedRedemptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRelatedRedemptions:
        """Create an instance of RedemptionRelatedRedemptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRelatedRedemptions.parse_obj(obj)
