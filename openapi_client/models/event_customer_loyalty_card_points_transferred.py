...
class EventCustomerLoyaltyCardPointsTransferred(BaseModel):
    """
    Event data object schema for `customer.voucher.loyalty_card.points_transferred`.  # noqa: E501
    """
    ...
    __properties = ["customer", "campaign", "voucher", "source_voucher", "destination_voucher", "balance", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyCardPointsTransferred:
        """Create an instance of EventCustomerLoyaltyCardPointsTransferred from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyCardPointsTransferred:
        """Create an instance of EventCustomerLoyaltyCardPointsTransferred from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyCardPointsTransferred.parse_obj(obj)

        _obj = EventCustomerLoyaltyCardPointsTransferred.parse_obj({
