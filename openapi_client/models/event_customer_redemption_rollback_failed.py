...
class EventCustomerRedemptionRollbackFailed(BaseModel):
    """
    Event data object schema for `customer.redemption.rollback.failed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRedemptionRollbackFailed:
        """Create an instance of EventCustomerRedemptionRollbackFailed from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRedemptionRollbackFailed:
        """Create an instance of EventCustomerRedemptionRollbackFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRedemptionRollbackFailed.parse_obj(obj)

        _obj = EventCustomerRedemptionRollbackFailed.parse_obj({
