...
class ApplicableToResultList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicableToResultList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicableToResultList:
        """Create an instance of ApplicableToResultList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicableToResultList.parse_obj(obj)

        _obj = ApplicableToResultList.parse_obj({
            "data": [ApplicableTo.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "total": obj.get("total"),
