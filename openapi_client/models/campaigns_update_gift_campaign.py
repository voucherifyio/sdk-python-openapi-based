...
class CampaignsUpdateGiftCampaign(BaseModel):
    """
    ...
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "gift"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateGiftCampaign:
        """Create an instance of CampaignsUpdateGiftCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateGiftCampaign:
        """Create an instance of CampaignsUpdateGiftCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateGiftCampaign.parse_obj(obj)

        _obj = CampaignsUpdateGiftCampaign.parse_obj({
