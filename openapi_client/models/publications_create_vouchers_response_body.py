...
class PublicationsCreateVouchersResponseBody(BaseModel):
    """
    Response body schema for **POST** `/publication` and **GET** `/publications/create`.  # noqa: E501
    """
    ...
    vouchers: conlist(StrictStr) = Field(..., description="Contains the unique voucher codes that was assigned by Voucherify.")
    __properties = ["id", "object", "created_at", "customer_id", "tracking_id", "metadata", "channel", "source_id", "result", "customer", "vouchers_id", "vouchers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicationsCreateVouchersResponseBody:
        """Create an instance of PublicationsCreateVouchersResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicationsCreateVouchersResponseBody:
        """Create an instance of PublicationsCreateVouchersResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicationsCreateVouchersResponseBody.parse_obj(obj)

        _obj = PublicationsCreateVouchersResponseBody.parse_obj({
            "id": obj.get("id"),
