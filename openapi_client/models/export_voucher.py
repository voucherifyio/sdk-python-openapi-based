...
class ExportVoucher(BaseModel):
    ...
    parameters: Optional[ExportVoucherBaseParameters] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportVoucher:
        """Create an instance of ExportVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportVoucher:
        """Create an instance of ExportVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportVoucher.parse_obj(obj)

        _obj = ExportVoucher.parse_obj({
            "id": obj.get("id"),
            ...
            "exported_object": obj.get("exported_object") if obj.get("exported_object") is not None else 'voucher',
            "parameters": ExportVoucherBaseParameters.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None
        })
        return _obj
