...
class ExportVoucherTransactions(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportVoucherTransactions:
        """Create an instance of ExportVoucherTransactions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportVoucherTransactions:
        """Create an instance of ExportVoucherTransactions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportVoucherTransactions.parse_obj(obj)

        _obj = ExportVoucherTransactions.parse_obj({
            "id": obj.get("id"),
