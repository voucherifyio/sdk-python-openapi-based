...
class OrdersCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `/orders`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersCreateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersCreateResponseBody:
        """Create an instance of OrdersCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersCreateResponseBody.parse_obj(obj)

        _obj = OrdersCreateResponseBody.parse_obj({
            "id": obj.get("id"),
