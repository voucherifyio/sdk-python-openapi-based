...
class CampaignsVouchersCreateBaseRequestBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateBaseRequestBody:
        """Create an instance of CampaignsVouchersCreateBaseRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateBaseRequestBody:
        """Create an instance of CampaignsVouchersCreateBaseRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateBaseRequestBody.parse_obj(obj)

        _obj = CampaignsVouchersCreateBaseRequestBody.parse_obj({
