...
class EventCustomerSent(BaseModel):
    """
    EventCustomerSent
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerSent:
        """Create an instance of EventCustomerSent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerSent:
        """Create an instance of EventCustomerSent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerSent.parse_obj(obj)

        _obj = EventCustomerSent.parse_obj({
