...
class ExportPointsExpirationScheduled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportPointsExpirationScheduled:
        """Create an instance of ExportPointsExpirationScheduled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportPointsExpirationScheduled:
        """Create an instance of ExportPointsExpirationScheduled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportPointsExpirationScheduled.parse_obj(obj)

        _obj = ExportPointsExpirationScheduled.parse_obj({
            "id": obj.get("id"),
