...
class StackableValidateRedeemBase(BaseModel):
    """
    ...
    __properties = ["redeemables", "order", "customer", "session", "tracking_id", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StackableValidateRedeemBase:
        """Create an instance of StackableValidateRedeemBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StackableValidateRedeemBase:
        """Create an instance of StackableValidateRedeemBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StackableValidateRedeemBase.parse_obj(obj)

        _obj = StackableValidateRedeemBase.parse_obj({
