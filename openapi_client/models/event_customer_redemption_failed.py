...
class EventCustomerRedemptionFailed(BaseModel):
    """
    Event data object schema for `customer.redemption.failed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRedemptionFailed:
        """Create an instance of EventCustomerRedemptionFailed from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRedemptionFailed:
        """Create an instance of EventCustomerRedemptionFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRedemptionFailed.parse_obj(obj)

        _obj = EventCustomerRedemptionFailed.parse_obj({
