...
class EventCustomerOrderUpdated(BaseModel):
    """
    Event data object schema for `customer.order.updated`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerOrderUpdated:
        """Create an instance of EventCustomerOrderUpdated from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerOrderUpdated:
        """Create an instance of EventCustomerOrderUpdated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerOrderUpdated.parse_obj(obj)

        _obj = EventCustomerOrderUpdated.parse_obj({
