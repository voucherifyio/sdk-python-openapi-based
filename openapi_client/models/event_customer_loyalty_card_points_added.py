...
class EventCustomerLoyaltyCardPointsAdded(BaseModel):
    """
    Event data object schema for `customer.voucher.loyalty_card.points_added`.  # noqa: E501
    """
    ...
    __properties = ["customer", "campaign", "voucher", "balance", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyCardPointsAdded:
        """Create an instance of EventCustomerLoyaltyCardPointsAdded from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyCardPointsAdded:
        """Create an instance of EventCustomerLoyaltyCardPointsAdded from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyCardPointsAdded.parse_obj(obj)

        _obj = EventCustomerLoyaltyCardPointsAdded.parse_obj({
