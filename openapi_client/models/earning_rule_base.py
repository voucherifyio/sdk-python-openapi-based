...
class EarningRuleBase(BaseModel):
    """
    EarningRuleBase
    """
    ...
    __properties = ["id", "created_at", "loyalty", "event", "custom_event", "segment", "source", "object", "automation_id", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleBase:
        """Create an instance of EarningRuleBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleBase:
        """Create an instance of EarningRuleBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleBase.parse_obj(obj)

        _obj = EarningRuleBase.parse_obj({
            "id": obj.get("id"),
