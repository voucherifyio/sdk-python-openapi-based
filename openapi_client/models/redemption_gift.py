...
class RedemptionGift(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionGift:
        """Create an instance of RedemptionGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionGift:
        """Create an instance of RedemptionGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionGift.parse_obj(obj)

        _obj = RedemptionGift.parse_obj({
