...
class BusValRuleAssignment(BaseModel):
    ...
    validation_status: StrictStr = Field(..., description="The validation status of the assignment")
    validation_omitted_rules: conlist(StrictStr) = Field(..., description="The list of omitted rules")
