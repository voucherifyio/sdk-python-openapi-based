...
class EventCustomerOrder(BaseModel):
    """
    EventCustomerOrder
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerOrder:
        """Create an instance of EventCustomerOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerOrder:
        """Create an instance of EventCustomerOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerOrder.parse_obj(obj)

        _obj = EventCustomerOrder.parse_obj({
