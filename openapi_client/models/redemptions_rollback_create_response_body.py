...
class RedemptionsRollbackCreateResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsRollbackCreateResponseBody:
        """Create an instance of RedemptionsRollbackCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsRollbackCreateResponseBody:
        """Create an instance of RedemptionsRollbackCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsRollbackCreateResponseBody.parse_obj(obj)

        _obj = RedemptionsRollbackCreateResponseBody.parse_obj({
            "id": obj.get("id"),
