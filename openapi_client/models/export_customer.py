...
class ExportCustomer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportCustomer:
        """Create an instance of ExportCustomer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportCustomer:
        """Create an instance of ExportCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportCustomer.parse_obj(obj)

        _obj = ExportCustomer.parse_obj({
            "id": obj.get("id"),
