...
class ProductCollectionsProductsListResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductCollectionsProductsListResponseBody:
        """Create an instance of ProductCollectionsProductsListResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductCollectionsProductsListResponseBody:
        """Create an instance of ProductCollectionsProductsListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductCollectionsProductsListResponseBody.parse_obj(obj)
