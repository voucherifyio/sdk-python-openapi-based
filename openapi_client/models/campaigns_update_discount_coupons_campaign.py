...
class CampaignsUpdateDiscountCouponsCampaign(BaseModel):
    """
    ...
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "discount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateDiscountCouponsCampaign:
        """Create an instance of CampaignsUpdateDiscountCouponsCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateDiscountCouponsCampaign:
        """Create an instance of CampaignsUpdateDiscountCouponsCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateDiscountCouponsCampaign.parse_obj(obj)

        _obj = CampaignsUpdateDiscountCouponsCampaign.parse_obj({
