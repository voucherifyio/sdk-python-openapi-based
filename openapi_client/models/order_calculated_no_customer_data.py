...
class OrderCalculatedNoCustomerData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCalculatedNoCustomerData:
        """Create an instance of OrderCalculatedNoCustomerData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCalculatedNoCustomerData:
        """Create an instance of OrderCalculatedNoCustomerData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCalculatedNoCustomerData.parse_obj(obj)

        _obj = OrderCalculatedNoCustomerData.parse_obj({
            "id": obj.get("id"),
