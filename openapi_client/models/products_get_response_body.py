...
class ProductsGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `/products/{productId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsGetResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsGetResponseBody:
        """Create an instance of ProductsGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductsGetResponseBody.parse_obj(obj)

        _obj = ProductsGetResponseBody.parse_obj({
            "id": obj.get("id"),
