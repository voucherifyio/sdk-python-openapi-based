...
class GiveawayCampaignVoucher(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GiveawayCampaignVoucher:
        """Create an instance of GiveawayCampaignVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GiveawayCampaignVoucher:
        """Create an instance of GiveawayCampaignVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GiveawayCampaignVoucher.parse_obj(obj)

        _obj = GiveawayCampaignVoucher.parse_obj({
