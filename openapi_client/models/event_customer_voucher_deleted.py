...
class EventCustomerVoucherDeleted(BaseModel):
    """
    Event data object schema for `customer.voucher.deleted`.  # noqa: E501
    """
    customer: Optional[SimpleCustomer] = None
    campaign: Optional[SimpleCampaign] = None
    voucher: Optional[SimpleVoucher] = None
    __properties = ["customer", "campaign", "voucher"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerVoucherDeleted:
        """Create an instance of EventCustomerVoucherDeleted from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerVoucherDeleted:
        """Create an instance of EventCustomerVoucherDeleted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerVoucherDeleted.parse_obj(obj)

        _obj = EventCustomerVoucherDeleted.parse_obj({
