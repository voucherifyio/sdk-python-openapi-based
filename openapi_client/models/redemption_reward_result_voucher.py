...
class RedemptionRewardResultVoucher(BaseModel):
    """
    Defines of the voucher.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRewardResultVoucher:
        """Create an instance of RedemptionRewardResultVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRewardResultVoucher:
        """Create an instance of RedemptionRewardResultVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRewardResultVoucher.parse_obj(obj)

        _obj = RedemptionRewardResultVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
