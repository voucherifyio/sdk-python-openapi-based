...
class RedemptionsRedeemResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsRedeemResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsRedeemResponseBody:
        """Create an instance of RedemptionsRedeemResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsRedeemResponseBody.parse_obj(obj)

        _obj = RedemptionsRedeemResponseBody.parse_obj({
