...
class ReferrerWithSummaryLoyaltyReferrals(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferrerWithSummaryLoyaltyReferrals:
        """Create an instance of ReferrerWithSummaryLoyaltyReferrals from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferrerWithSummaryLoyaltyReferrals:
        """Create an instance of ReferrerWithSummaryLoyaltyReferrals from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferrerWithSummaryLoyaltyReferrals.parse_obj(obj)

        _obj = ReferrerWithSummaryLoyaltyReferrals.parse_obj({
            "id": obj.get("id"),
