...
class PromotionsStacksCreateResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsStacksCreateResponseBody:
        """Create an instance of PromotionsStacksCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsStacksCreateResponseBody:
        """Create an instance of PromotionsStacksCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsStacksCreateResponseBody.parse_obj(obj)
