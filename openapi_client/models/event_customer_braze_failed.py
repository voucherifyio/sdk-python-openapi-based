...
class EventCustomerBrazeFailed(BaseModel):
    """
    Event data object schema for `customer.braze.failed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerBrazeFailed:
        """Create an instance of EventCustomerBrazeFailed from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerBrazeFailed:
        """Create an instance of EventCustomerBrazeFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerBrazeFailed.parse_obj(obj)

        _obj = EventCustomerBrazeFailed.parse_obj({
