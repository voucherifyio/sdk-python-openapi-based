...
class QualificationsCheckEligibilityRequestBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualificationsCheckEligibilityRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualificationsCheckEligibilityRequestBody:
        """Create an instance of QualificationsCheckEligibilityRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualificationsCheckEligibilityRequestBody.parse_obj(obj)

        _obj = QualificationsCheckEligibilityRequestBody.parse_obj({
