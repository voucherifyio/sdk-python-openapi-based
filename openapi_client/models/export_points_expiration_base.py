...
class ExportPointsExpirationBase(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportPointsExpirationBase:
        """Create an instance of ExportPointsExpirationBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportPointsExpirationBase:
        """Create an instance of ExportPointsExpirationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportPointsExpirationBase.parse_obj(obj)

        _obj = ExportPointsExpirationBase.parse_obj({
