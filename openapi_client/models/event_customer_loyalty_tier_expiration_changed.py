...
class EventCustomerLoyaltyTierExpirationChanged(BaseModel):
    """
    Event data object schema for `customer.loyalty.tier.expiration.changed`.  # noqa: E501
    """
    ...
    __properties = ["customer", "campaign", "loyalty_tier", "created_at", "expiration_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyTierExpirationChanged:
        """Create an instance of EventCustomerLoyaltyTierExpirationChanged from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyTierExpirationChanged:
        """Create an instance of EventCustomerLoyaltyTierExpirationChanged from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyTierExpirationChanged.parse_obj(obj)

        _obj = EventCustomerLoyaltyTierExpirationChanged.parse_obj({
