...
class OrdersExportCreateRequestBodyParameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersExportCreateRequestBodyParameters:
        """Create an instance of OrdersExportCreateRequestBodyParameters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersExportCreateRequestBodyParameters:
        """Create an instance of OrdersExportCreateRequestBodyParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersExportCreateRequestBodyParameters.parse_obj(obj)
