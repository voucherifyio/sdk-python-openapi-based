...
class LoyaltiesEarningRulesEnableResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesEnableResponseBody:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesEnableResponseBody:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesEnableResponseBody.parse_obj(obj)
