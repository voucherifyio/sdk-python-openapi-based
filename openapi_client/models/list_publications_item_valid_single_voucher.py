...
class ListPublicationsItemValidSingleVoucher(BaseModel):
    """
    ...
    voucher: ListPublicationsItemVoucher = Field(...)
    __properties = ["id", "object", "created_at", "customer_id", "tracking_id", "metadata", "channel", "source_id", "customer", "vouchers_id", "result", "voucher"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPublicationsItemValidSingleVoucher:
        """Create an instance of ListPublicationsItemValidSingleVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPublicationsItemValidSingleVoucher:
        """Create an instance of ListPublicationsItemValidSingleVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListPublicationsItemValidSingleVoucher.parse_obj(obj)

        _obj = ListPublicationsItemValidSingleVoucher.parse_obj({
            "id": obj.get("id"),
