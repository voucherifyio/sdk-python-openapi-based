...
class VouchersTransactionsExportCreateResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersTransactionsExportCreateResponseBody:
        """Create an instance of VouchersTransactionsExportCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersTransactionsExportCreateResponseBody:
        """Create an instance of VouchersTransactionsExportCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersTransactionsExportCreateResponseBody.parse_obj(obj)

        _obj = VouchersTransactionsExportCreateResponseBody.parse_obj({
            "id": obj.get("id"),
