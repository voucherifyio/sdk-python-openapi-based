...
class EventCustomerLoyaltyUpdated(BaseModel):
    """
    Event data object schema for `customer.loyalty.updated`.  # noqa: E501
    """
    customer: Optional[SimpleCustomer] = None
    campaign: Optional[SimpleCampaign] = None
    loyalty: Optional[Dict[str, Any]] = None
    created_at: datetime = Field(...)
    __properties = ["customer", "campaign", "loyalty", "created_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyUpdated:
        """Create an instance of EventCustomerLoyaltyUpdated from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyUpdated:
        """Create an instance of EventCustomerLoyaltyUpdated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyUpdated.parse_obj(obj)

        _obj = EventCustomerLoyaltyUpdated.parse_obj({
