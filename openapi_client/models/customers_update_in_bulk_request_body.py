...
class CustomersUpdateInBulkRequestBody(BaseModel):
    """
    Request body schema for **POST** `/customers/bulk/async`.  # noqa: E501
    """
    ...
    source_id: StrictStr = Field(..., description="Unique customer source ID.")
    __properties = ["name", "description", "email", "phone", "birthday", "birthdate", "address", "metadata", "source_id"]
