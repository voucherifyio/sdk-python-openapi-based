...
class PromotionsStacksUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `/promotions/{campaignId}/stacks/{stackId}`.  # noqa: E501
    """
    ...
    updated_at: datetime = Field(..., description="Timestamp representing the date and time when the promotion stack was updated in ISO 8601 format.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsStacksUpdateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsStacksUpdateResponseBody:
        """Create an instance of PromotionsStacksUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsStacksUpdateResponseBody.parse_obj(obj)

        _obj = PromotionsStacksUpdateResponseBody.parse_obj({
            "name": obj.get("name"),
            ...
            "categories": [PromotionStackBase.from_dict(_item) for _item in obj.get("categories")] if obj.get("categories") is not None else None
        })
        return _obj
