...
class ExportVoucherFields(str, Enum):
    """
    ExportVoucherFields
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportVoucherFields:
        """Create an instance of ExportVoucherFields from a JSON string"""
        return ExportVoucherFields(json.loads(json_str))
