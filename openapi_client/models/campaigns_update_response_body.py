...
class CampaignsUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `/campaigns/{campaignId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateResponseBody:
        """Create an instance of CampaignsUpdateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateResponseBody:
        """Create an instance of CampaignsUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateResponseBody.parse_obj(obj)

        _obj = CampaignsUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
