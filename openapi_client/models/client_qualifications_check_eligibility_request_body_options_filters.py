...
class ClientQualificationsCheckEligibilityRequestBodyOptionsFilters(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientQualificationsCheckEligibilityRequestBodyOptionsFilters:
        """Create an instance of ClientQualificationsCheckEligibilityRequestBodyOptionsFilters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientQualificationsCheckEligibilityRequestBodyOptionsFilters:
        """Create an instance of ClientQualificationsCheckEligibilityRequestBodyOptionsFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientQualificationsCheckEligibilityRequestBodyOptionsFilters.parse_obj(obj)

        _obj = ClientQualificationsCheckEligibilityRequestBodyOptionsFilters.parse_obj({
