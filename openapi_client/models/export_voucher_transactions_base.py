...
class ExportVoucherTransactionsBase(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportVoucherTransactionsBase:
        """Create an instance of ExportVoucherTransactionsBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportVoucherTransactionsBase:
        """Create an instance of ExportVoucherTransactionsBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportVoucherTransactionsBase.parse_obj(obj)

        _obj = ExportVoucherTransactionsBase.parse_obj({
