...
class LoyaltiesMembersTransactionsExportCreateResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersTransactionsExportCreateResponseBody:
        """Create an instance of LoyaltiesMembersTransactionsExportCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersTransactionsExportCreateResponseBody:
        """Create an instance of LoyaltiesMembersTransactionsExportCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersTransactionsExportCreateResponseBody.parse_obj(obj)

        _obj = LoyaltiesMembersTransactionsExportCreateResponseBody.parse_obj({
            "id": obj.get("id"),
