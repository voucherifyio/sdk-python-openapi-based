...
**type** | **str** | Defines whether the campaign can be updated with new vouchers after campaign creation.      - &#x60;AUTO_UPDATE&#x60;: the campaign is dynamic, i.e. vouchers will generate based on set criteria     -  &#x60;STATIC&#x60;: vouchers need to be manually published | 
...
**creation_status** | **str** | Indicates the status of the campaign creation. | 
**vouchers_generation_status** | **str** | Indicates the status of the campaign&#39;s vouchers. | 
...
**object** | **str** | The type of object represented by JSON. This object stores information about the campaign. | [default to 'campaign']
