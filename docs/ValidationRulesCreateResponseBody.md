...
------------ | ------------- | ------------- | -------------
**name** | **str** | Custom, unique name for set of validation rules. | 
...
**type** | **str** | Type of validation rule. | [default to 'expression']
...
**id** | **str** | Unique validation rule ID. | 
...
**object** | **str** | The type of object represented by JSON. This object stores information about the validation rule. | [default to 'validation_rules']
