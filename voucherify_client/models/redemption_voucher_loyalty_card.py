...
class RedemptionVoucherLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionVoucherLoyaltyCard:
        """Create an instance of RedemptionVoucherLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionVoucherLoyaltyCard:
        """Create an instance of RedemptionVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionVoucherLoyaltyCard.parse_obj(obj)

        _obj = RedemptionVoucherLoyaltyCard.parse_obj({
