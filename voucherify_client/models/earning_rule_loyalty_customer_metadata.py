...
class EarningRuleLoyaltyCustomerMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyCustomerMetadata:
        """Create an instance of EarningRuleLoyaltyCustomerMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyCustomerMetadata:
        """Create an instance of EarningRuleLoyaltyCustomerMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyCustomerMetadata.parse_obj(obj)

        _obj = EarningRuleLoyaltyCustomerMetadata.parse_obj({
            "every": obj.get("every"),
