...
class ValidationRulesGetResponseBodyApplicableTo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesGetResponseBodyApplicableTo:
        """Create an instance of ValidationRulesGetResponseBodyApplicableTo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesGetResponseBodyApplicableTo:
        """Create an instance of ValidationRulesGetResponseBodyApplicableTo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesGetResponseBodyApplicableTo.parse_obj(obj)

        _obj = ValidationRulesGetResponseBodyApplicableTo.parse_obj({
