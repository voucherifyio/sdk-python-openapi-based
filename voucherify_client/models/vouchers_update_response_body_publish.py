...
class VouchersUpdateResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateResponseBodyPublish:
        """Create an instance of VouchersUpdateResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateResponseBodyPublish:
        """Create an instance of VouchersUpdateResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateResponseBodyPublish.parse_obj(obj)

        _obj = VouchersUpdateResponseBodyPublish.parse_obj({
