...
class EarningRuleLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyOrderItemsQuantity:
        """Create an instance of EarningRuleLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyOrderItemsQuantity:
        """Create an instance of EarningRuleLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = EarningRuleLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
