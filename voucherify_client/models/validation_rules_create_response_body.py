...
class ValidationRulesCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/validation-rules`.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> ValidationRulesCreateResponseBody:
        ...
        _obj = ValidationRulesCreateResponseBody.parse_obj({
            "name": obj.get("name"),
            "rules": obj.get("rules"),
            "error": ValidationRulesCreateResponseBodyError.from_dict(obj.get("error")) if obj.get("error") is not None else None,
            "applicable_to": ValidationRulesCreateResponseBodyApplicableTo.from_dict(obj.get("applicable_to")) if obj.get("applicable_to") is not None else None,
