...
class CampaignsCreateGiveawayCampaign(BaseModel):
    """
    ...
    campaign_type: Optional[StrictStr] = Field('LUCKY_DRAW', description="Type of campaign.")
    voucher: Optional[GiveawayCampaignVoucher] = None
    lucky_draw: Optional[LuckyDraw] = None
    __properties = ["name", "description", "type", "join_once", "auto_join", "use_voucher_metadata_schema", "vouchers_count", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "activity_duration_after_publishing", "validation_rules", "category_id", "category", "metadata", "campaign_type", "voucher", "lucky_draw"]
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in ('LUCKY_DRAW',):
            raise ValueError("must be one of enum values ('LUCKY_DRAW')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreateGiveawayCampaign:
        """Create an instance of CampaignsCreateGiveawayCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreateGiveawayCampaign:
        """Create an instance of CampaignsCreateGiveawayCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreateGiveawayCampaign.parse_obj(obj)

        _obj = CampaignsCreateGiveawayCampaign.parse_obj({
            "name": obj.get("name"),
            ...
            "campaign_type": obj.get("campaign_type") if obj.get("campaign_type") is not None else 'LUCKY_DRAW',
            "voucher": GiveawayCampaignVoucher.from_dict(obj.get("voucher")) if obj.get("voucher") is not None else None,
            "lucky_draw": LuckyDraw.from_dict(obj.get("lucky_draw")) if obj.get("lucky_draw") is not None else None
        })
        return _obj
