...
class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
