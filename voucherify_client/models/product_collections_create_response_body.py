...
class ProductCollectionsCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/product-collections`.  # noqa: E501
    """
    ...
    products: Optional[conlist(ProductCollectionsCreateResponseBodyProductsItem)] = Field(None, description="Defines a set of products for a `STATIC` product collection type.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductCollectionsCreateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductCollectionsCreateResponseBody:
        """Create an instance of ProductCollectionsCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductCollectionsCreateResponseBody.parse_obj(obj)

        _obj = ProductCollectionsCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "filter": ProductCollectionsCreateResponseBodyFilter.from_dict(obj.get("filter")) if obj.get("filter") is not None else None,
            "products": [ProductCollectionsCreateResponseBodyProductsItem.from_dict(_item) for _item in obj.get("products")] if obj.get("products") is not None else None,
