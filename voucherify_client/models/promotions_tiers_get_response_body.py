...
class PromotionsTiersGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `/promotions/tiers/{promotionTierId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersGetResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersGetResponseBody:
        """Create an instance of PromotionsTiersGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersGetResponseBody.parse_obj(obj)

        _obj = PromotionsTiersGetResponseBody.parse_obj({
            "id": obj.get("id"),
