...
class PromotionsTiersGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/promotions/tiers/{promotionTierId}`.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> PromotionsTiersGetResponseBody:
        ...
        _obj = PromotionsTiersGetResponseBody.parse_obj({
            ...
            "action": PromotionsTiersGetResponseBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "metadata": obj.get("metadata"),
            "hierarchy": obj.get("hierarchy"),
            "promotion_id": obj.get("promotion_id"),
            "campaign": PromotionsTiersGetResponseBodyCampaign.from_dict(obj.get("campaign")) if obj.get("campaign") is not None else None,
            ...
            "summary": PromotionsTiersGetResponseBodySummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
