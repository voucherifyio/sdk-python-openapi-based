...
class ValidationsValidateRequestBodyOptions(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationsValidateRequestBodyOptions:
        """Create an instance of ValidationsValidateRequestBodyOptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationsValidateRequestBodyOptions:
        """Create an instance of ValidationsValidateRequestBodyOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationsValidateRequestBodyOptions.parse_obj(obj)

        _obj = ValidationsValidateRequestBodyOptions.parse_obj({
