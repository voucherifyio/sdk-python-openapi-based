...
class LoyaltiesEarningRulesEnableResponseBodyLoyalty(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesEnableResponseBodyLoyalty:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyalty from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesEnableResponseBodyLoyalty:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyalty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesEnableResponseBodyLoyalty.parse_obj(obj)

        _obj = LoyaltiesEarningRulesEnableResponseBodyLoyalty.parse_obj({
            "type": obj.get("type"),
            "calculation_type": obj.get("calculation_type"),
            "order": LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrder.from_dict(obj.get("order")) if obj.get("order") is not None else None,
            "order_items": LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItems.from_dict(obj.get("order_items")) if obj.get("order_items") is not None else None,
            "customer": LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
            "custom_event": LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
