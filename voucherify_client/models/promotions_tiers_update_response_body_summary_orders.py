...
class PromotionsTiersUpdateResponseBodySummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersUpdateResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersUpdateResponseBodySummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersUpdateResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersUpdateResponseBodySummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersUpdateResponseBodySummaryOrders.parse_obj(obj)

        _obj = PromotionsTiersUpdateResponseBodySummaryOrders.parse_obj({
