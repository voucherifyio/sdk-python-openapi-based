...
class EarningRuleLoyalty(BaseModel):
    """
    EarningRuleLoyalty
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyalty:
        """Create an instance of EarningRuleLoyalty from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyalty:
        """Create an instance of EarningRuleLoyalty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyalty.parse_obj(obj)

        _obj = EarningRuleLoyalty.parse_obj({
            "type": obj.get("type"),
            "calculation_type": obj.get("calculation_type"),
            "order": EarningRuleLoyaltyOrder.from_dict(obj.get("order")) if obj.get("order") is not None else None,
            "order_items": EarningRuleLoyaltyOrderItems.from_dict(obj.get("order_items")) if obj.get("order_items") is not None else None,
            "customer": EarningRuleLoyaltyCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
            "custom_event": EarningRuleLoyaltyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
