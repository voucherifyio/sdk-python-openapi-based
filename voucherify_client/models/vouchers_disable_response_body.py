...
class VouchersDisableResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/vouchers/{code}/disable`.  # noqa: E501
    """
    ...
    gift: Optional[VouchersDisableResponseBodyGift] = None
    loyalty_card: Optional[VouchersDisableResponseBodyLoyaltyCard] = None
    ...
    publish: Optional[VouchersDisableResponseBodyPublish] = None
    redemption: Optional[VouchersDisableResponseBodyRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersDisableResponseBody:
        """Create an instance of VouchersDisableResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersDisableResponseBody:
        """Create an instance of VouchersDisableResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersDisableResponseBody.parse_obj(obj)

        _obj = VouchersDisableResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": VouchersDisableResponseBodyGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VouchersDisableResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VouchersDisableResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VouchersDisableResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
