...
class EventCustomerPublicationSucceeded(BaseModel):
    """
    Event data object schema for `customer.publication.succeeded`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerPublicationSucceeded:
        """Create an instance of EventCustomerPublicationSucceeded from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerPublicationSucceeded:
        """Create an instance of EventCustomerPublicationSucceeded from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerPublicationSucceeded.parse_obj(obj)

        _obj = EventCustomerPublicationSucceeded.parse_obj({
