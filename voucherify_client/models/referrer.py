...
class Referrer(BaseModel):
    ...
    address: Optional[ReferrerAddress] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Referrer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Referrer:
        """Create an instance of Referrer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Referrer.parse_obj(obj)

        _obj = Referrer.parse_obj({
            "id": obj.get("id"),
            ...
            "address": ReferrerAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
