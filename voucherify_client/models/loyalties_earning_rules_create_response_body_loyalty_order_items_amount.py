...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
