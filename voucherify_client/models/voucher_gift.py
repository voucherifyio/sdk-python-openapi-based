...
class VoucherGift(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherGift:
        """Create an instance of VoucherGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherGift:
        """Create an instance of VoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherGift.parse_obj(obj)

        _obj = VoucherGift.parse_obj({
