...
class LoyaltiesMembersGetResponseBodyRedemption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersGetResponseBodyRedemption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersGetResponseBodyRedemption:
        """Create an instance of LoyaltiesMembersGetResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersGetResponseBodyRedemption.parse_obj(obj)

        _obj = LoyaltiesMembersGetResponseBodyRedemption.parse_obj({
