...
class AsyncActionBase(BaseModel):
    """
    This is an object representing an asynchronous action.  # noqa: E501
    """
    ...
    __properties = ["id", "type", "status", "operation_status", "created_at", "updated_at", "request_id", "processing_time", "progress", "object"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AsyncActionBase:
        """Create an instance of AsyncActionBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AsyncActionBase:
        """Create an instance of AsyncActionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AsyncActionBase.parse_obj(obj)

        _obj = AsyncActionBase.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
