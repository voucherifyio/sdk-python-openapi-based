...
class LoyaltyTierPoints(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyTierPoints:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyTierPoints:
        """Create an instance of LoyaltyTierPoints from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyTierPoints.parse_obj(obj)

        _obj = LoyaltyTierPoints.parse_obj({
