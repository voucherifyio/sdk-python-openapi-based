...
class PromotionsTiersUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/promotions/tiers/{promotionTierId}`.  # noqa: E501
    """
    ...
    action: Optional[PromotionsTiersUpdateResponseBodyAction] = None
    ...
    campaign: Optional[PromotionsTiersUpdateResponseBodyCampaign] = None
    ...
    summary: Optional[PromotionsTiersUpdateResponseBodySummary] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersUpdateResponseBody:
        """Create an instance of PromotionsTiersUpdateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersUpdateResponseBody:
        """Create an instance of PromotionsTiersUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersUpdateResponseBody.parse_obj(obj)

        _obj = PromotionsTiersUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "name": obj.get("name"),
            "banner": obj.get("banner"),
            "action": PromotionsTiersUpdateResponseBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "metadata": obj.get("metadata"),
            "hierarchy": obj.get("hierarchy"),
            "promotion_id": obj.get("promotion_id"),
            "campaign": PromotionsTiersUpdateResponseBodyCampaign.from_dict(obj.get("campaign")) if obj.get("campaign") is not None else None,
            ...
            "summary": PromotionsTiersUpdateResponseBodySummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
