...
class ParameterFiltersListCustomerRedeemablesCampaignTypeConditions(BaseModel):
    """
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM',):
                raise ValueError("each list item must be one of ('LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM')")
        return value
    ...
    def var_is_validate_enum(cls, value):
        ...
        if value not in ('LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM',):
            raise ValueError("must be one of enum values ('LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParameterFiltersListCustomerRedeemablesCampaignTypeConditions:
        """Create an instance of ParameterFiltersListCustomerRedeemablesCampaignTypeConditions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParameterFiltersListCustomerRedeemablesCampaignTypeConditions:
        """Create an instance of ParameterFiltersListCustomerRedeemablesCampaignTypeConditions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.parse_obj(obj)

        _obj = ParameterFiltersListCustomerRedeemablesCampaignTypeConditions.parse_obj({
            "var_in": obj.get("$in"),
