...
class LoyaltyMemberPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyMemberPublish:
        """Create an instance of LoyaltyMemberPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyMemberPublish:
        """Create an instance of LoyaltyMemberPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyMemberPublish.parse_obj(obj)

        _obj = LoyaltyMemberPublish.parse_obj({
