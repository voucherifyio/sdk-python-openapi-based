...
class RedemptionsListResponseBodyRedemptionsItemVoucherRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemVoucherRedemption:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucherRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemVoucherRedemption:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucherRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.parse_obj({
