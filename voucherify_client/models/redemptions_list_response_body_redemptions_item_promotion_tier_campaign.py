...
class RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign.parse_obj({
            "id": obj.get("id"),
