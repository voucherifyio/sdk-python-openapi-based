...
class RedemptionsGetResponseBodyOrder(BaseModel):
    """
    ...
    customer: Optional[RedemptionsGetResponseBodyOrderCustomer] = None
    referrer: Optional[RedemptionsGetResponseBodyOrderReferrer] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyOrder:
        """Create an instance of RedemptionsGetResponseBodyOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyOrder:
        """Create an instance of RedemptionsGetResponseBodyOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyOrder.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyOrder.parse_obj({
            "id": obj.get("id"),
            ...
            "customer": RedemptionsGetResponseBodyOrderCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
            "referrer": RedemptionsGetResponseBodyOrderReferrer.from_dict(obj.get("referrer")) if obj.get("referrer") is not None else None,
