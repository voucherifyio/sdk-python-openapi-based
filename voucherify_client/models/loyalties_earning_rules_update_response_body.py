...
class LoyaltiesEarningRulesUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/loyalties/{campaignId}/earning-rules/{earningRuleId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBody:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBody.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "loyalty": LoyaltiesEarningRulesUpdateResponseBodyLoyalty.from_dict(obj.get("loyalty")) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": LoyaltiesEarningRulesUpdateResponseBodyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
            "segment": LoyaltiesEarningRulesUpdateResponseBodySegment.from_dict(obj.get("segment")) if obj.get("segment") is not None else None,
            "loyalty_tier": LoyaltiesEarningRulesUpdateResponseBodyLoyaltyTier.from_dict(obj.get("loyalty_tier")) if obj.get("loyalty_tier") is not None else None,
            "source": LoyaltiesEarningRulesUpdateResponseBodySource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
