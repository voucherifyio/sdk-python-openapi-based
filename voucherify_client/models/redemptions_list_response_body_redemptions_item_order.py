...
class RedemptionsListResponseBodyRedemptionsItemOrder(BaseModel):
    """
    ...
    customer: Optional[RedemptionsListResponseBodyRedemptionsItemOrderCustomer] = None
    referrer: Optional[RedemptionsListResponseBodyRedemptionsItemOrderReferrer] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemOrder:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemOrder:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemOrder.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemOrder.parse_obj({
            "id": obj.get("id"),
            ...
            "customer": RedemptionsListResponseBodyRedemptionsItemOrderCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
            "referrer": RedemptionsListResponseBodyRedemptionsItemOrderReferrer.from_dict(obj.get("referrer")) if obj.get("referrer") is not None else None,
