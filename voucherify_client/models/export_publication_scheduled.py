...
class ExportPublicationScheduled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportPublicationScheduled:
        """Create an instance of ExportPublicationScheduled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportPublicationScheduled:
        """Create an instance of ExportPublicationScheduled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportPublicationScheduled.parse_obj(obj)

        _obj = ExportPublicationScheduled.parse_obj({
            "id": obj.get("id"),
