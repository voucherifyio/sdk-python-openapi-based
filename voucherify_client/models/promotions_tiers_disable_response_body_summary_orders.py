...
class PromotionsTiersDisableResponseBodySummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersDisableResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersDisableResponseBodySummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersDisableResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersDisableResponseBodySummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersDisableResponseBodySummaryOrders.parse_obj(obj)

        _obj = PromotionsTiersDisableResponseBodySummaryOrders.parse_obj({
