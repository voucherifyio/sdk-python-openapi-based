...
class RedemptionsGetResponseBodyPromotionTierCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyPromotionTierCampaign:
        """Create an instance of RedemptionsGetResponseBodyPromotionTierCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyPromotionTierCampaign:
        """Create an instance of RedemptionsGetResponseBodyPromotionTierCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyPromotionTierCampaign.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyPromotionTierCampaign.parse_obj({
            "id": obj.get("id"),
