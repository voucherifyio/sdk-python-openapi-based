...
class VoucherWithCategoriesLoyaltyCard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherWithCategoriesLoyaltyCard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherWithCategoriesLoyaltyCard:
        """Create an instance of VoucherWithCategoriesLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherWithCategoriesLoyaltyCard.parse_obj(obj)

        _obj = VoucherWithCategoriesLoyaltyCard.parse_obj({
