...
class ReferrerId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferrerId:
        """Create an instance of ReferrerId from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferrerId:
        """Create an instance of ReferrerId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferrerId.parse_obj(obj)

        _obj = ReferrerId.parse_obj({
            "id": obj.get("id"),
