...
class LoyaltiesMemberActivityListResponseBody(BaseModel):
    """
    Response body schema for retrieving member activity.  # noqa: E501
    """
    object: Optional[StrictStr] = Field('list', description="The type of the object represented by JSON. This object stores information about member activities in a dictionary.")
    data_ref: Optional[StrictStr] = Field('data', description="Identifies the name of the attribute that contains the array of member activity objects.")
    data: Optional[conlist(MemberActivity)] = Field(None, description="Array of member activity objects.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMemberActivityListResponseBody:
        """Create an instance of LoyaltiesMemberActivityListResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMemberActivityListResponseBody:
        """Create an instance of LoyaltiesMemberActivityListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMemberActivityListResponseBody.parse_obj(obj)

        _obj = LoyaltiesMemberActivityListResponseBody.parse_obj({
            ...
            "data": [MemberActivity.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
