...
class RedemptionsGetResponseBodyVoucherGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyVoucherGift:
        """Create an instance of RedemptionsGetResponseBodyVoucherGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyVoucherGift:
        """Create an instance of RedemptionsGetResponseBodyVoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyVoucherGift.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyVoucherGift.parse_obj({
