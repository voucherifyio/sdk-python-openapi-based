...
class VouchersDisableResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersDisableResponseBodyLoyaltyCard:
        """Create an instance of VouchersDisableResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersDisableResponseBodyLoyaltyCard:
        """Create an instance of VouchersDisableResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersDisableResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = VouchersDisableResponseBodyLoyaltyCard.parse_obj({
