...
class RedemptionsGetResponseBodyVoucherLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyVoucherLoyaltyCard:
        """Create an instance of RedemptionsGetResponseBodyVoucherLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyVoucherLoyaltyCard:
        """Create an instance of RedemptionsGetResponseBodyVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyVoucherLoyaltyCard.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyVoucherLoyaltyCard.parse_obj({
