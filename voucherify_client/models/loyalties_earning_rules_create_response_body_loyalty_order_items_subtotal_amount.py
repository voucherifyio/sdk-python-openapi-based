...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
