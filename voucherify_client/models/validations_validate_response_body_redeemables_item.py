...
class ValidationsValidateResponseBodyRedeemablesItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationsValidateResponseBodyRedeemablesItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationsValidateResponseBodyRedeemablesItem:
        """Create an instance of ValidationsValidateResponseBodyRedeemablesItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationsValidateResponseBodyRedeemablesItem.parse_obj(obj)

        _obj = ValidationsValidateResponseBodyRedeemablesItem.parse_obj({
            ...
            "result": ValidationsValidateResponseBodyRedeemablesItemResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
