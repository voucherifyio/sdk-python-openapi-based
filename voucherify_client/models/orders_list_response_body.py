...
class OrdersListResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersListResponseBody:
        """Create an instance of OrdersListResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersListResponseBody:
        """Create an instance of OrdersListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersListResponseBody.parse_obj(obj)
