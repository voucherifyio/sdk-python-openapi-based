...
class ProductCollectionsCreateRequestBodyFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductCollectionsCreateRequestBodyFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductCollectionsCreateRequestBodyFilter:
        """Create an instance of ProductCollectionsCreateRequestBodyFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductCollectionsCreateRequestBodyFilter.parse_obj(obj)

        _obj = ProductCollectionsCreateRequestBodyFilter.parse_obj({
