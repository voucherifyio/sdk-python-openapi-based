...
class CustomerBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerBase:
        """Create an instance of CustomerBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerBase:
        """Create an instance of CustomerBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerBase.parse_obj(obj)

        _obj = CustomerBase.parse_obj({
            "name": obj.get("name"),
