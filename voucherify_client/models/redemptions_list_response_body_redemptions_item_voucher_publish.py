...
class RedemptionsListResponseBodyRedemptionsItemVoucherPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemVoucherPublish:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucherPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemVoucherPublish:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucherPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemVoucherPublish.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemVoucherPublish.parse_obj({
