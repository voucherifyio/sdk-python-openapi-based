...
class ValidationRulesUpdateResponseBodyApplicableTo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesUpdateResponseBodyApplicableTo:
        """Create an instance of ValidationRulesUpdateResponseBodyApplicableTo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesUpdateResponseBodyApplicableTo:
        """Create an instance of ValidationRulesUpdateResponseBodyApplicableTo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesUpdateResponseBodyApplicableTo.parse_obj(obj)

        _obj = ValidationRulesUpdateResponseBodyApplicableTo.parse_obj({
