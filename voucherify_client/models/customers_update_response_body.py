...
class CustomersUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/customers/{customerId}`.  # noqa: E501
    """
    ...
    assets: Optional[CustomersUpdateResponseBodyAssets] = None
    ...
    address: Optional[CustomersUpdateResponseBodyAddress] = None
    ...
    def from_dict(cls, obj: dict) -> CustomersUpdateResponseBody:
        ...
        _obj = CustomersUpdateResponseBody.parse_obj({
            ...
            "assets": CustomersUpdateResponseBodyAssets.from_dict(obj.get("assets")) if obj.get("assets") is not None else None,
            ...
            "address": CustomersUpdateResponseBodyAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
