...
class LoyaltiesCreateCampaignResponseBody(BaseModel):
    """
    Response body schema for **POST** `/loyalties`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesCreateCampaignResponseBody:
        """Create an instance of LoyaltiesCreateCampaignResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesCreateCampaignResponseBody:
        """Create an instance of LoyaltiesCreateCampaignResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesCreateCampaignResponseBody.parse_obj(obj)

        _obj = LoyaltiesCreateCampaignResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
