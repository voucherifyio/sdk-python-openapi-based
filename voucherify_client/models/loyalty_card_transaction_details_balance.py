...
class LoyaltyCardTransactionDetailsBalance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyCardTransactionDetailsBalance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyCardTransactionDetailsBalance:
        """Create an instance of LoyaltyCardTransactionDetailsBalance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyCardTransactionDetailsBalance.parse_obj(obj)

        _obj = LoyaltyCardTransactionDetailsBalance.parse_obj({
            ...
            "related_object": LoyaltyCardTransactionDetailsBalanceRelatedObject.from_dict(obj.get("related_object")) if obj.get("related_object") is not None else None
        })
        return _obj
