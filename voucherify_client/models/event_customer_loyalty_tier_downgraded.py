...
class EventCustomerLoyaltyTierDowngraded(BaseModel):
    """
    Event data object schema for `customer.loyalty.tier.downgraded`.  # noqa: E501
    """
    customer: Optional[SimpleCustomer] = None
    campaign: Optional[SimpleCampaign] = None
    loyalty_tier_from: LoyaltyTier = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyTierDowngraded:
        """Create an instance of EventCustomerLoyaltyTierDowngraded from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyTierDowngraded:
        """Create an instance of EventCustomerLoyaltyTierDowngraded from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyTierDowngraded.parse_obj(obj)

        _obj = EventCustomerLoyaltyTierDowngraded.parse_obj({
