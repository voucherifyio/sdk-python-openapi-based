...
class ClientValidationsValidateRequestBodyRedeemablesItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientValidationsValidateRequestBodyRedeemablesItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientValidationsValidateRequestBodyRedeemablesItem:
        """Create an instance of ClientValidationsValidateRequestBodyRedeemablesItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientValidationsValidateRequestBodyRedeemablesItem.parse_obj(obj)

        _obj = ClientValidationsValidateRequestBodyRedeemablesItem.parse_obj({
            "object": obj.get("object"),
            "id": obj.get("id"),
            "gift": ClientValidationsValidateRequestBodyRedeemablesItemGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "reward": ClientValidationsValidateRequestBodyRedeemablesItemReward.from_dict(obj.get("reward")) if obj.get("reward") is not None else None
        })
        return _obj
