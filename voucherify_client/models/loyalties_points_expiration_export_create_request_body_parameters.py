...
class LoyaltiesPointsExpirationExportCreateRequestBodyParameters(BaseModel):
    """
    List of fields and filters that will be used to create the export.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesPointsExpirationExportCreateRequestBodyParameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesPointsExpirationExportCreateRequestBodyParameters:
        """Create an instance of LoyaltiesPointsExpirationExportCreateRequestBodyParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesPointsExpirationExportCreateRequestBodyParameters.parse_obj(obj)

        _obj = LoyaltiesPointsExpirationExportCreateRequestBodyParameters.parse_obj({
            "order": obj.get("order"),
            "fields": obj.get("fields"),
            "filters": LoyaltiesPointsExpirationExportCreateRequestBodyParametersFilters.from_dict(obj.get("filters")) if obj.get("filters") is not None else None
        })
        return _obj
