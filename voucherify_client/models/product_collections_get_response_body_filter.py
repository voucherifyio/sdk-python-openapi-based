...
class ProductCollectionsGetResponseBodyFilter(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductCollectionsGetResponseBodyFilter:
        """Create an instance of ProductCollectionsGetResponseBodyFilter from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductCollectionsGetResponseBodyFilter:
        """Create an instance of ProductCollectionsGetResponseBodyFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductCollectionsGetResponseBodyFilter.parse_obj(obj)

        _obj = ProductCollectionsGetResponseBodyFilter.parse_obj({
