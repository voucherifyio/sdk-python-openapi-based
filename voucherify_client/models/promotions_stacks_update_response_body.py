...
class PromotionsStacksUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/promotions/{campaignId}/stacks/{stackId}`.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> PromotionsStacksUpdateResponseBody:
        ...
        _obj = PromotionsStacksUpdateResponseBody.parse_obj({
            "name": obj.get("name"),
            "tiers": PromotionsStacksUpdateResponseBodyTiers.from_dict(obj.get("tiers")) if obj.get("tiers") is not None else None,
            "id": obj.get("id"),
