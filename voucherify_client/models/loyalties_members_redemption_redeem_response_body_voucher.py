...
class LoyaltiesMembersRedemptionRedeemResponseBodyVoucher(BaseModel):
    """
    Defines the details of the voucher being redeemed.  # noqa: E501
    """
    ...
    gift: Optional[LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift] = None
    loyalty_card: Optional[LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucher:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucher:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.parse_obj(obj)

        _obj = LoyaltiesMembersRedemptionRedeemResponseBodyVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltiesMembersRedemptionRedeemResponseBodyVoucherPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
