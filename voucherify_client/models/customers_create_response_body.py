...
class CustomersCreateResponseBody(BaseModel):
    """
    Response body for **POST** `v1/customers`.  # noqa: E501
    """
    ...
    assets: Optional[CustomersCreateResponseBodyAssets] = None
    ...
    address: Optional[CustomersCreateResponseBodyAddress] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersCreateResponseBody:
        """Create an instance of CustomersCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersCreateResponseBody:
        """Create an instance of CustomersCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersCreateResponseBody.parse_obj(obj)

        _obj = CustomersCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            ...
            "assets": CustomersCreateResponseBodyAssets.from_dict(obj.get("assets")) if obj.get("assets") is not None else None,
            ...
            "address": CustomersCreateResponseBodyAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
