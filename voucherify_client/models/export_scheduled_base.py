...
class ExportScheduledBase(BaseModel):
    """
    ExportScheduledBase
    """
    ...
    __properties = ["id", "object", "created_at", "status", "channel", "result", "user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportScheduledBase:
        """Create an instance of ExportScheduledBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportScheduledBase:
        """Create an instance of ExportScheduledBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportScheduledBase.parse_obj(obj)

        _obj = ExportScheduledBase.parse_obj({
            "id": obj.get("id"),
