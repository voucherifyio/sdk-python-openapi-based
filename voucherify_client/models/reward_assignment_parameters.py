...
class RewardAssignmentParameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardAssignmentParameters:
        """Create an instance of RewardAssignmentParameters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardAssignmentParameters:
        """Create an instance of RewardAssignmentParameters from a dict"""
        if obj is None:
            return None
