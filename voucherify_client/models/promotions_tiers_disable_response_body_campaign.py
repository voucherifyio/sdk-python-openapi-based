...
class PromotionsTiersDisableResponseBodyCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersDisableResponseBodyCampaign:
        """Create an instance of PromotionsTiersDisableResponseBodyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersDisableResponseBodyCampaign:
        """Create an instance of PromotionsTiersDisableResponseBodyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersDisableResponseBodyCampaign.parse_obj(obj)

        _obj = PromotionsTiersDisableResponseBodyCampaign.parse_obj({
            "id": obj.get("id"),
