...
class ExportOrderScheduled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportOrderScheduled:
        """Create an instance of ExportOrderScheduled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportOrderScheduled:
        """Create an instance of ExportOrderScheduled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportOrderScheduled.parse_obj(obj)

        _obj = ExportOrderScheduled.parse_obj({
            "id": obj.get("id"),
