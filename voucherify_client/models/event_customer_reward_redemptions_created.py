...
class EventCustomerRewardRedemptionsCreated(BaseModel):
    """
    Event data object schema for `customer.reward_redemptions.created`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRewardRedemptionsCreated:
        """Create an instance of EventCustomerRewardRedemptionsCreated from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRewardRedemptionsCreated:
        """Create an instance of EventCustomerRewardRedemptionsCreated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRewardRedemptionsCreated.parse_obj(obj)

        _obj = EventCustomerRewardRedemptionsCreated.parse_obj({
