...
class ExportsCreateResponseBodyParameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportsCreateResponseBodyParameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportsCreateResponseBodyParameters:
        """Create an instance of ExportsCreateResponseBodyParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportsCreateResponseBodyParameters.parse_obj(obj)

        _obj = ExportsCreateResponseBodyParameters.parse_obj({
            "order": obj.get("order"),
            "fields": obj.get("fields"),
            "filters": ExportsCreateResponseBodyParametersFilters.from_dict(obj.get("filters")) if obj.get("filters") is not None else None
        })
        return _obj
