...
class CampaignsVouchersCreateResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateResponseBodyGift:
        """Create an instance of CampaignsVouchersCreateResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateResponseBodyGift:
        """Create an instance of CampaignsVouchersCreateResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateResponseBodyGift.parse_obj(obj)

        _obj = CampaignsVouchersCreateResponseBodyGift.parse_obj({
