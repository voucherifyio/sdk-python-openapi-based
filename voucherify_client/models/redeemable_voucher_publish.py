...
class RedeemableVoucherPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedeemableVoucherPublish:
        """Create an instance of RedeemableVoucherPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedeemableVoucherPublish:
        """Create an instance of RedeemableVoucherPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedeemableVoucherPublish.parse_obj(obj)

        _obj = RedeemableVoucherPublish.parse_obj({
