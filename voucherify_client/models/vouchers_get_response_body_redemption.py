...
class VouchersGetResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersGetResponseBodyRedemption:
        """Create an instance of VouchersGetResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersGetResponseBodyRedemption:
        """Create an instance of VouchersGetResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersGetResponseBodyRedemption.parse_obj(obj)

        _obj = VouchersGetResponseBodyRedemption.parse_obj({
