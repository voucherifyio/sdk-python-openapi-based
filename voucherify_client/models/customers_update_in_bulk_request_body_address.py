...
class CustomersUpdateInBulkRequestBodyAddress(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersUpdateInBulkRequestBodyAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersUpdateInBulkRequestBodyAddress:
        """Create an instance of CustomersUpdateInBulkRequestBodyAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersUpdateInBulkRequestBodyAddress.parse_obj(obj)

        _obj = CustomersUpdateInBulkRequestBodyAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
