...
class LoyaltiesCreateCampaignRequestBody(BaseModel):
    """
    Request body schema for **POST** `/loyalties`.  # noqa: E501
    """
    ...
    __properties = ["name", "description", "type", "join_once", "auto_join", "use_voucher_metadata_schema", "vouchers_count", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "activity_duration_after_publishing", "validation_rules", "category_id", "category", "metadata", "campaign_type", "voucher"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesCreateCampaignRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesCreateCampaignRequestBody:
        """Create an instance of LoyaltiesCreateCampaignRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesCreateCampaignRequestBody.parse_obj(obj)

        _obj = LoyaltiesCreateCampaignRequestBody.parse_obj({
            "name": obj.get("name"),
