...
class PublicationsCreateRequestBodyCustomer(BaseModel):
    """
    ...
    address: Optional[PublicationsCreateRequestBodyCustomerAddress] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicationsCreateRequestBodyCustomer:
        """Create an instance of PublicationsCreateRequestBodyCustomer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicationsCreateRequestBodyCustomer:
        """Create an instance of PublicationsCreateRequestBodyCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicationsCreateRequestBodyCustomer.parse_obj(obj)

        _obj = PublicationsCreateRequestBodyCustomer.parse_obj({
            "id": obj.get("id"),
            ...
            "address": PublicationsCreateRequestBodyCustomerAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
