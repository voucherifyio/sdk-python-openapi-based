...
class LoyaltiesEarningRulesDisableResponseBodySource(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodySource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodySource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodySource.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodySource.parse_obj({
