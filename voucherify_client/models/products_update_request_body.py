...
class ProductsUpdateRequestBody(BaseModel):
    ...
    __properties = ["name", "price", "attributes", "metadata", "image_url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductsUpdateRequestBody:
        """Create an instance of ProductsUpdateRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductsUpdateRequestBody:
        """Create an instance of ProductsUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductsUpdateRequestBody.parse_obj(obj)

        _obj = ProductsUpdateRequestBody.parse_obj({
            "name": obj.get("name"),
            "price": obj.get("price"),
