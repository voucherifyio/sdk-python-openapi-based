...
class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption.parse_obj(obj)

        _obj = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption.parse_obj({
