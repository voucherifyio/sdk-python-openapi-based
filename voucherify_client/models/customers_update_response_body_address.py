...
class CustomersUpdateResponseBodyAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersUpdateResponseBodyAddress:
        """Create an instance of CustomersUpdateResponseBodyAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersUpdateResponseBodyAddress:
        """Create an instance of CustomersUpdateResponseBodyAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersUpdateResponseBodyAddress.parse_obj(obj)

        _obj = CustomersUpdateResponseBodyAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
