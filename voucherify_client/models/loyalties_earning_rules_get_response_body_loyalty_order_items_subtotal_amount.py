...
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
