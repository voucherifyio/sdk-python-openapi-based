...
class CustomersGetResponseBodyAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersGetResponseBodyAddress:
        """Create an instance of CustomersGetResponseBodyAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersGetResponseBodyAddress:
        """Create an instance of CustomersGetResponseBodyAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersGetResponseBodyAddress.parse_obj(obj)

        _obj = CustomersGetResponseBodyAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
