...
class CategoriesGetResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoriesGetResponseBody:
        """Create an instance of CategoriesGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoriesGetResponseBody:
        """Create an instance of CategoriesGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoriesGetResponseBody.parse_obj(obj)

        _obj = CategoriesGetResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
