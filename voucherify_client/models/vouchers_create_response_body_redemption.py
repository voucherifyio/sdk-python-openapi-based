...
class VouchersCreateResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersCreateResponseBodyRedemption:
        """Create an instance of VouchersCreateResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersCreateResponseBodyRedemption:
        """Create an instance of VouchersCreateResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersCreateResponseBodyRedemption.parse_obj(obj)

        _obj = VouchersCreateResponseBodyRedemption.parse_obj({
