...
class LoyaltiesMembersGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `/loyalties/{campaignId}/members/{memberId}` and **GET** `/loyalties/members/{memberId}`.  # noqa: E501
    """
    ...
    category: Optional[StrictStr] = Field(None, description="Tag defining the category that this voucher belongs to.")
    ...
    loyalty_card: Optional[LoyaltiesMembersGetResponseBodyLoyaltyCard] = None
    ...
    is_referral_code: Optional[StrictBool] = Field(None, description="This is always false for loyalty members.")
    ...
    holder_id: Optional[StrictStr] = Field(None, description="Unique identifier of the customer who owns the voucher.")
    object: Optional[StrictStr] = Field('voucher', description="The type of the object represented by JSON. Default is `voucher`.")
    publish: Optional[LoyaltiesMembersGetResponseBodyPublish] = None
    redemption: Optional[LoyaltiesMembersGetResponseBodyRedemption] = None
    __properties = ["id", "code", "campaign", "campaign_id", "category", "category_id", "type", "discount", "gift", "loyalty_card", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "active", "additional_info", "metadata", "assets", "is_referral_code", "created_at", "updated_at", "holder_id", "object", "publish", "redemption"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersGetResponseBody:
        """Create an instance of LoyaltiesMembersGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersGetResponseBody:
        """Create an instance of LoyaltiesMembersGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersGetResponseBody.parse_obj(obj)

        _obj = LoyaltiesMembersGetResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": obj.get("gift"),
            "loyalty_card": LoyaltiesMembersGetResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltiesMembersGetResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": LoyaltiesMembersGetResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None
        })
        return _obj
