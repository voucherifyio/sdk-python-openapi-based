...
class PublicationsCreateRequestBodyCustomerAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicationsCreateRequestBodyCustomerAddress:
        """Create an instance of PublicationsCreateRequestBodyCustomerAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicationsCreateRequestBodyCustomerAddress:
        """Create an instance of PublicationsCreateRequestBodyCustomerAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicationsCreateRequestBodyCustomerAddress.parse_obj(obj)

        _obj = PublicationsCreateRequestBodyCustomerAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
