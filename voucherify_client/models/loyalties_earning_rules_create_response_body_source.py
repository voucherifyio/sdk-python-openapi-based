...
class LoyaltiesEarningRulesCreateResponseBodySource(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodySource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodySource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodySource.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodySource.parse_obj({
