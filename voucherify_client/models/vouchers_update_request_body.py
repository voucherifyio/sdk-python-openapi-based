...
class VouchersUpdateRequestBody(BaseModel):
    ...
    __properties = ["category", "category_id", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "active", "additional_info", "metadata", "type", "loyalty_card", "gift", "discount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateRequestBody:
        """Create an instance of VouchersUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateRequestBody.parse_obj(obj)

        _obj = VouchersUpdateRequestBody.parse_obj({
