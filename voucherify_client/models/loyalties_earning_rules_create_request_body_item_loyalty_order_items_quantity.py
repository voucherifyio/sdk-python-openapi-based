...
class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
