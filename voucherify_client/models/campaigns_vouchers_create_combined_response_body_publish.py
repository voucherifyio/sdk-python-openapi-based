...
class CampaignsVouchersCreateCombinedResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateCombinedResponseBodyPublish:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateCombinedResponseBodyPublish:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateCombinedResponseBodyPublish.parse_obj(obj)

        _obj = CampaignsVouchersCreateCombinedResponseBodyPublish.parse_obj({
