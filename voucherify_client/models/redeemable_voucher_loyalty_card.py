...
class RedeemableVoucherLoyaltyCard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedeemableVoucherLoyaltyCard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedeemableVoucherLoyaltyCard:
        """Create an instance of RedeemableVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedeemableVoucherLoyaltyCard.parse_obj(obj)

        _obj = RedeemableVoucherLoyaltyCard.parse_obj({
