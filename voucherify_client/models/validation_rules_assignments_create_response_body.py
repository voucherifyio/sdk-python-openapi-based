...
class ValidationRulesAssignmentsCreateResponseBody(BaseModel):
    """
    Response body for **POST** `v1/validation-rules/{validationRuleId}/assignments`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesAssignmentsCreateResponseBody:
        """Create an instance of ValidationRulesAssignmentsCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesAssignmentsCreateResponseBody:
        """Create an instance of ValidationRulesAssignmentsCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesAssignmentsCreateResponseBody.parse_obj(obj)

        _obj = ValidationRulesAssignmentsCreateResponseBody.parse_obj({
            "id": obj.get("id"),
