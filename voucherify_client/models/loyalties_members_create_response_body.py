...
class LoyaltiesMembersCreateResponseBody(BaseModel):
    """
    Respone body schema for assigning a loyalty card to a customer using **POST** `/loyalties/{campaignId}/members`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersCreateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersCreateResponseBody:
        """Create an instance of LoyaltiesMembersCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersCreateResponseBody.parse_obj(obj)

        _obj = LoyaltiesMembersCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": obj.get("gift"),
            "loyalty_card": LoyaltiesMembersCreateResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltiesMembersCreateResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": LoyaltiesMembersCreateResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None
        })
        return _obj
