...
class LoyaltiesTiersListResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesTiersListResponseBody:
        """Create an instance of LoyaltiesTiersListResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesTiersListResponseBody:
        """Create an instance of LoyaltiesTiersListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesTiersListResponseBody.parse_obj(obj)

        _obj = LoyaltiesTiersListResponseBody.parse_obj({
