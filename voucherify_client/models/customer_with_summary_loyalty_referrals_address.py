...
class CustomerWithSummaryLoyaltyReferralsAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerWithSummaryLoyaltyReferralsAddress:
        """Create an instance of CustomerWithSummaryLoyaltyReferralsAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerWithSummaryLoyaltyReferralsAddress:
        """Create an instance of CustomerWithSummaryLoyaltyReferralsAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerWithSummaryLoyaltyReferralsAddress.parse_obj(obj)

        _obj = CustomerWithSummaryLoyaltyReferralsAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
