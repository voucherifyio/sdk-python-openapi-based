...
class PromotionStackTiers(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionStackTiers:
        """Create an instance of PromotionStackTiers from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionStackTiers:
        """Create an instance of PromotionStackTiers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionStackTiers.parse_obj(obj)

        _obj = PromotionStackTiers.parse_obj({
            "ids": obj.get("ids"),
