...
class VouchersEnableResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersEnableResponseBodyLoyaltyCard:
        """Create an instance of VouchersEnableResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersEnableResponseBodyLoyaltyCard:
        """Create an instance of VouchersEnableResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersEnableResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = VouchersEnableResponseBodyLoyaltyCard.parse_obj({
