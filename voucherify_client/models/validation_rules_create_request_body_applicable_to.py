...
class ValidationRulesCreateRequestBodyApplicableTo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesCreateRequestBodyApplicableTo:
        """Create an instance of ValidationRulesCreateRequestBodyApplicableTo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesCreateRequestBodyApplicableTo:
        """Create an instance of ValidationRulesCreateRequestBodyApplicableTo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesCreateRequestBodyApplicableTo.parse_obj(obj)

        _obj = ValidationRulesCreateRequestBodyApplicableTo.parse_obj({
