...
class OrdersExportCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/orders/export`.  # noqa: E501
    """
    ...
    exported_object: Optional[StrictStr] = Field('order', description="The type of object to be exported.")
    parameters: Optional[OrdersExportCreateResponseBodyParameters] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersExportCreateResponseBody:
        """Create an instance of OrdersExportCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersExportCreateResponseBody:
        """Create an instance of OrdersExportCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersExportCreateResponseBody.parse_obj(obj)

        _obj = OrdersExportCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            ...
            "exported_object": obj.get("exported_object") if obj.get("exported_object") is not None else 'order',
            "parameters": OrdersExportCreateResponseBodyParameters.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None
        })
        return _obj
