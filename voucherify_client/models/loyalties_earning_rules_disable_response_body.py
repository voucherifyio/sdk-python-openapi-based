...
class LoyaltiesEarningRulesDisableResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/loyalties/{campaignId}/earning-rules/{earningRuleId}/disable`  # noqa: E501
    """
    ...
    loyalty: Optional[LoyaltiesEarningRulesDisableResponseBodyLoyalty] = None
    event: Optional[StrictStr] = None
    custom_event: Optional[LoyaltiesEarningRulesDisableResponseBodyCustomEvent] = None
    segment: Optional[LoyaltiesEarningRulesDisableResponseBodySegment] = None
    loyalty_tier: Optional[LoyaltiesEarningRulesDisableResponseBodyLoyaltyTier] = None
    source: Optional[LoyaltiesEarningRulesDisableResponseBodySource] = None
    ...
    active: Optional[StrictBool] = Field(False, description="A flag to toggle the earning rule on or off. You can disable an earning rule even though it's within the active period defined by the start_date and expiration_date of the campaign or the earning rule's own start_date and expiration_date.")
    ...
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBody:
        ...
        _obj = LoyaltiesEarningRulesDisableResponseBody.parse_obj({
            ...
            "loyalty": LoyaltiesEarningRulesDisableResponseBodyLoyalty.from_dict(obj.get("loyalty")) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": LoyaltiesEarningRulesDisableResponseBodyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
            "segment": LoyaltiesEarningRulesDisableResponseBodySegment.from_dict(obj.get("segment")) if obj.get("segment") is not None else None,
            "loyalty_tier": LoyaltiesEarningRulesDisableResponseBodyLoyaltyTier.from_dict(obj.get("loyalty_tier")) if obj.get("loyalty_tier") is not None else None,
            "source": LoyaltiesEarningRulesDisableResponseBodySource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
