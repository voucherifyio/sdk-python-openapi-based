...
class CreatePublicationWithCampaign(BaseModel):
    """
    ...
    campaign: CreatePublicationCampaign = Field(...)
    __properties = ["source_id", "customer", "metadata", "campaign"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePublicationWithCampaign:
        """Create an instance of CreatePublicationWithCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePublicationWithCampaign:
        """Create an instance of CreatePublicationWithCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePublicationWithCampaign.parse_obj(obj)

        _obj = CreatePublicationWithCampaign.parse_obj({
