...
class LoyaltyMemberRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyMemberRedemption:
        """Create an instance of LoyaltyMemberRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyMemberRedemption:
        """Create an instance of LoyaltyMemberRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyMemberRedemption.parse_obj(obj)

        _obj = LoyaltyMemberRedemption.parse_obj({
