...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
