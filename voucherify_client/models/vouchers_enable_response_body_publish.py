...
class VouchersEnableResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersEnableResponseBodyPublish:
        """Create an instance of VouchersEnableResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersEnableResponseBodyPublish:
        """Create an instance of VouchersEnableResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersEnableResponseBodyPublish.parse_obj(obj)

        _obj = VouchersEnableResponseBodyPublish.parse_obj({
