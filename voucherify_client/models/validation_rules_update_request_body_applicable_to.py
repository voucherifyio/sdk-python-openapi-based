...
class ValidationRulesUpdateRequestBodyApplicableTo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesUpdateRequestBodyApplicableTo:
        """Create an instance of ValidationRulesUpdateRequestBodyApplicableTo from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesUpdateRequestBodyApplicableTo:
        """Create an instance of ValidationRulesUpdateRequestBodyApplicableTo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesUpdateRequestBodyApplicableTo.parse_obj(obj)

        _obj = ValidationRulesUpdateRequestBodyApplicableTo.parse_obj({
