...
class SimpleLoyaltyCard(BaseModel):
    """
    Simplified loyalty card data.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimpleLoyaltyCard:
        """Create an instance of SimpleLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimpleLoyaltyCard:
        """Create an instance of SimpleLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimpleLoyaltyCard.parse_obj(obj)

        _obj = SimpleLoyaltyCard.parse_obj({
