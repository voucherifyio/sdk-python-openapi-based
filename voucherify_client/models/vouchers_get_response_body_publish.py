...
class VouchersGetResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersGetResponseBodyPublish:
        """Create an instance of VouchersGetResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersGetResponseBodyPublish:
        """Create an instance of VouchersGetResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersGetResponseBodyPublish.parse_obj(obj)

        _obj = VouchersGetResponseBodyPublish.parse_obj({
