...
class ValidationRulesCreateResponseBodyApplicableTo(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesCreateResponseBodyApplicableTo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesCreateResponseBodyApplicableTo:
        """Create an instance of ValidationRulesCreateResponseBodyApplicableTo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesCreateResponseBodyApplicableTo.parse_obj(obj)

        _obj = ValidationRulesCreateResponseBodyApplicableTo.parse_obj({
