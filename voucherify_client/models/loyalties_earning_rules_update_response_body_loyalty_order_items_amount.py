...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
