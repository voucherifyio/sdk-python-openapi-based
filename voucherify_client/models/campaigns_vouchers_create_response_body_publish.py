...
class CampaignsVouchersCreateResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateResponseBodyPublish:
        """Create an instance of CampaignsVouchersCreateResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateResponseBodyPublish:
        """Create an instance of CampaignsVouchersCreateResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateResponseBodyPublish.parse_obj(obj)

        _obj = CampaignsVouchersCreateResponseBodyPublish.parse_obj({
