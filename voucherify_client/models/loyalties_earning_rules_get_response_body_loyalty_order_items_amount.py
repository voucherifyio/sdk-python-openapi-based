...
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
