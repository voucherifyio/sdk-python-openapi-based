...
class PromotionsTiersGetResponseBodyCampaign(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersGetResponseBodyCampaign:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersGetResponseBodyCampaign:
        """Create an instance of PromotionsTiersGetResponseBodyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersGetResponseBodyCampaign.parse_obj(obj)

        _obj = PromotionsTiersGetResponseBodyCampaign.parse_obj({
            "id": obj.get("id"),
