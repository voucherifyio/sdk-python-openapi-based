...
class EventsCreateRequestBodyReferral(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventsCreateRequestBodyReferral:
        """Create an instance of EventsCreateRequestBodyReferral from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventsCreateRequestBodyReferral:
        """Create an instance of EventsCreateRequestBodyReferral from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventsCreateRequestBodyReferral.parse_obj(obj)

        _obj = EventsCreateRequestBodyReferral.parse_obj({
            "code": obj.get("code"),
