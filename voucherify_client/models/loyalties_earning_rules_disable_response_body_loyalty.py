...
class LoyaltiesEarningRulesDisableResponseBodyLoyalty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodyLoyalty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodyLoyalty:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyalty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodyLoyalty.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodyLoyalty.parse_obj({
            "type": obj.get("type"),
            "calculation_type": obj.get("calculation_type"),
            "order": LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrder.from_dict(obj.get("order")) if obj.get("order") is not None else None,
            "order_items": LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItems.from_dict(obj.get("order_items")) if obj.get("order_items") is not None else None,
            "customer": LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer.from_dict(obj.get("customer")) if obj.get("customer") is not None else None,
            "custom_event": LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
