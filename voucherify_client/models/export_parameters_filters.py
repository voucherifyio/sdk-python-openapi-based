...
class ExportParametersFilters(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportParametersFilters:
        """Create an instance of ExportParametersFilters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportParametersFilters:
        """Create an instance of ExportParametersFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportParametersFilters.parse_obj(obj)

        _obj = ExportParametersFilters.parse_obj({
