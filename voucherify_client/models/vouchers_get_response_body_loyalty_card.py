...
class VouchersGetResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersGetResponseBodyLoyaltyCard:
        """Create an instance of VouchersGetResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersGetResponseBodyLoyaltyCard:
        """Create an instance of VouchersGetResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersGetResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = VouchersGetResponseBodyLoyaltyCard.parse_obj({
