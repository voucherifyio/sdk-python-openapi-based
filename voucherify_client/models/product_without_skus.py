...
class ProductWithoutSkus(BaseModel):
    """
    ProductWithoutSkus
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductWithoutSkus:
        """Create an instance of ProductWithoutSkus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductWithoutSkus:
        """Create an instance of ProductWithoutSkus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductWithoutSkus.parse_obj(obj)

        _obj = ProductWithoutSkus.parse_obj({
            "id": obj.get("id"),
