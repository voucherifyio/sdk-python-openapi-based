...
class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
