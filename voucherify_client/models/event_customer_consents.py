...
class EventCustomerConsents(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerConsents:
        """Create an instance of EventCustomerConsents from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerConsents:
        """Create an instance of EventCustomerConsents from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerConsents.parse_obj(obj)

        _obj = EventCustomerConsents.parse_obj({
