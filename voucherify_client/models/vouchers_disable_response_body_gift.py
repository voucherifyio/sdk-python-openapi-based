...
class VouchersDisableResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersDisableResponseBodyGift:
        """Create an instance of VouchersDisableResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersDisableResponseBodyGift:
        """Create an instance of VouchersDisableResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersDisableResponseBodyGift.parse_obj(obj)

        _obj = VouchersDisableResponseBodyGift.parse_obj({
