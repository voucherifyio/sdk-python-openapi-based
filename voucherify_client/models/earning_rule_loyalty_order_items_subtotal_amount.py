...
class EarningRuleLoyaltyOrderItemsSubtotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of EarningRuleLoyaltyOrderItemsSubtotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of EarningRuleLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = EarningRuleLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
