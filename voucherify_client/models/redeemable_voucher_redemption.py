...
class RedeemableVoucherRedemption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedeemableVoucherRedemption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedeemableVoucherRedemption:
        """Create an instance of RedeemableVoucherRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedeemableVoucherRedemption.parse_obj(obj)

        _obj = RedeemableVoucherRedemption.parse_obj({
