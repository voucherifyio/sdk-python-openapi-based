...
class SegmentsCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/segments`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SegmentsCreateResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SegmentsCreateResponseBody:
        """Create an instance of SegmentsCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SegmentsCreateResponseBody.parse_obj(obj)

        _obj = SegmentsCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
