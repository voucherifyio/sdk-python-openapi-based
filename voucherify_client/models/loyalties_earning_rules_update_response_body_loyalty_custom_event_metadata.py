...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
