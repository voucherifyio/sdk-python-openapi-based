...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
