...
class RedemptionsGetResponseBodyVoucher(BaseModel):
    """
    ...
    gift: Optional[RedemptionsGetResponseBodyVoucherGift] = None
    loyalty_card: Optional[RedemptionsGetResponseBodyVoucherLoyaltyCard] = None
    ...
    publish: Optional[RedemptionsGetResponseBodyVoucherPublish] = None
    redemption: Optional[RedemptionsGetResponseBodyVoucherRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyVoucher:
        """Create an instance of RedemptionsGetResponseBodyVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyVoucher:
        """Create an instance of RedemptionsGetResponseBodyVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyVoucher.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": RedemptionsGetResponseBodyVoucherGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": RedemptionsGetResponseBodyVoucherLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": RedemptionsGetResponseBodyVoucherPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": RedemptionsGetResponseBodyVoucherRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
