...
class VouchersUpdateResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateResponseBodyLoyaltyCard:
        """Create an instance of VouchersUpdateResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateResponseBodyLoyaltyCard:
        """Create an instance of VouchersUpdateResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = VouchersUpdateResponseBodyLoyaltyCard.parse_obj({
