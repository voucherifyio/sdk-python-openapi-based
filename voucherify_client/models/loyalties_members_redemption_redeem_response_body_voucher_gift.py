...
class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift(BaseModel):
    """
    Object representing gift parameters. Child attributes are present only if `type` is `GIFT_VOUCHER`. Defaults to `null`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.parse_obj(obj)

        _obj = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift.parse_obj({
