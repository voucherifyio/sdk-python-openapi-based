...
class RedemptionsGetResponseBodyPromotionTierSummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyPromotionTierSummaryOrders:
        """Create an instance of RedemptionsGetResponseBodyPromotionTierSummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyPromotionTierSummaryOrders:
        """Create an instance of RedemptionsGetResponseBodyPromotionTierSummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyPromotionTierSummaryOrders.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyPromotionTierSummaryOrders.parse_obj({
