...
class PromotionsStacksGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/promotions/{campaignId}/stacks/{stackId}`.  # noqa: E501
    """
    name: Optional[StrictStr] = Field(None, description="Promotion stack name.")
    tiers: Optional[PromotionsStacksGetResponseBodyTiers] = None
    ...
    def from_dict(cls, obj: dict) -> PromotionsStacksGetResponseBody:
        ...
        _obj = PromotionsStacksGetResponseBody.parse_obj({
            "name": obj.get("name"),
            "tiers": PromotionsStacksGetResponseBodyTiers.from_dict(obj.get("tiers")) if obj.get("tiers") is not None else None,
            "id": obj.get("id"),
