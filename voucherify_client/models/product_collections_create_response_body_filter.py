...
class ProductCollectionsCreateResponseBodyFilter(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductCollectionsCreateResponseBodyFilter:
        """Create an instance of ProductCollectionsCreateResponseBodyFilter from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductCollectionsCreateResponseBodyFilter:
        """Create an instance of ProductCollectionsCreateResponseBodyFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductCollectionsCreateResponseBodyFilter.parse_obj(obj)

        _obj = ProductCollectionsCreateResponseBodyFilter.parse_obj({
