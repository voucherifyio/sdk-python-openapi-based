...
class ValidationRulesUpdateRequestBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesUpdateRequestBody:
        """Create an instance of ValidationRulesUpdateRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesUpdateRequestBody:
        """Create an instance of ValidationRulesUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesUpdateRequestBody.parse_obj(obj)

        _obj = ValidationRulesUpdateRequestBody.parse_obj({
            "name": obj.get("name"),
            "rules": obj.get("rules"),
            "error": ValidationRulesUpdateRequestBodyError.from_dict(obj.get("error")) if obj.get("error") is not None else None,
            "applicable_to": ValidationRulesUpdateRequestBodyApplicableTo.from_dict(obj.get("applicable_to")) if obj.get("applicable_to") is not None else None,
