...
class VoucherWithCategoriesRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherWithCategoriesRedemption:
        """Create an instance of VoucherWithCategoriesRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherWithCategoriesRedemption:
        """Create an instance of VoucherWithCategoriesRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherWithCategoriesRedemption.parse_obj(obj)

        _obj = VoucherWithCategoriesRedemption.parse_obj({
