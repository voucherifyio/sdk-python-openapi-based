...
class OrderCalculatedItemProduct(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCalculatedItemProduct:
        """Create an instance of OrderCalculatedItemProduct from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCalculatedItemProduct:
        """Create an instance of OrderCalculatedItemProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCalculatedItemProduct.parse_obj(obj)

        _obj = OrderCalculatedItemProduct.parse_obj({
            "id": obj.get("id"),
