...
class RewardAttributes(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardAttributes:
        """Create an instance of RewardAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardAttributes:
        """Create an instance of RewardAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardAttributes.parse_obj(obj)

        _obj = RewardAttributes.parse_obj({
