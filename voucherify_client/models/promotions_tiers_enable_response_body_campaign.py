...
class PromotionsTiersEnableResponseBodyCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersEnableResponseBodyCampaign:
        """Create an instance of PromotionsTiersEnableResponseBodyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersEnableResponseBodyCampaign:
        """Create an instance of PromotionsTiersEnableResponseBodyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersEnableResponseBodyCampaign.parse_obj(obj)

        _obj = PromotionsTiersEnableResponseBodyCampaign.parse_obj({
            "id": obj.get("id"),
