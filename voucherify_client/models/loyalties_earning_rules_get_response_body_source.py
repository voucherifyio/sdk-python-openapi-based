...
class LoyaltiesEarningRulesGetResponseBodySource(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesGetResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodySource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodySource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesGetResponseBodySource.parse_obj(obj)

        _obj = LoyaltiesEarningRulesGetResponseBodySource.parse_obj({
