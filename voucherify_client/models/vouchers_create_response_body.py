...
class VouchersCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/vouchers` and `/vouchers/{code}`  # noqa: E501
    """
    ...
    gift: Optional[VouchersCreateResponseBodyGift] = None
    loyalty_card: Optional[VouchersCreateResponseBodyLoyaltyCard] = None
    ...
    publish: Optional[VouchersCreateResponseBodyPublish] = None
    redemption: Optional[VouchersCreateResponseBodyRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersCreateResponseBody:
        """Create an instance of VouchersCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersCreateResponseBody:
        """Create an instance of VouchersCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersCreateResponseBody.parse_obj(obj)

        _obj = VouchersCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": VouchersCreateResponseBodyGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VouchersCreateResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VouchersCreateResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VouchersCreateResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
