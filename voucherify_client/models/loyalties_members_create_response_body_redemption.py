...
class LoyaltiesMembersCreateResponseBodyRedemption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersCreateResponseBodyRedemption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersCreateResponseBodyRedemption:
        """Create an instance of LoyaltiesMembersCreateResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersCreateResponseBodyRedemption.parse_obj(obj)

        _obj = LoyaltiesMembersCreateResponseBodyRedemption.parse_obj({
