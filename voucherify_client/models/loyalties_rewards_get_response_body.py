...
class LoyaltiesRewardsGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/loyalties/{campaignId}/rewards/{assignmentId}`  # noqa: E501
    """
    ...
    parameters: Optional[LoyaltiesRewardsGetResponseBodyParameters] = None
    ...
    def from_dict(cls, obj: dict) -> LoyaltiesRewardsGetResponseBody:
        ...
        _obj = LoyaltiesRewardsGetResponseBody.parse_obj({
            ...
            "parameters": LoyaltiesRewardsGetResponseBodyParameters.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None
        })
        return _obj
