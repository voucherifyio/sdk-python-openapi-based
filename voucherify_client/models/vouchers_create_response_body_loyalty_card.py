...
class VouchersCreateResponseBodyLoyaltyCard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersCreateResponseBodyLoyaltyCard:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersCreateResponseBodyLoyaltyCard:
        """Create an instance of VouchersCreateResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersCreateResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = VouchersCreateResponseBodyLoyaltyCard.parse_obj({
