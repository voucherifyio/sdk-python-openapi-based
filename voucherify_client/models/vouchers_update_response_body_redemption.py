...
class VouchersUpdateResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateResponseBodyRedemption:
        """Create an instance of VouchersUpdateResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateResponseBodyRedemption:
        """Create an instance of VouchersUpdateResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateResponseBodyRedemption.parse_obj(obj)

        _obj = VouchersUpdateResponseBodyRedemption.parse_obj({
