...
class QualificationsOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QualificationsOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QualificationsOption:
        """Create an instance of QualificationsOption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QualificationsOption.parse_obj(obj)

        _obj = QualificationsOption.parse_obj({
            "limit": obj.get("limit"),
            "starting_after": obj.get("starting_after"),
            "filters": QualificationsOptionFilters.from_dict(obj.get("filters")) if obj.get("filters") is not None else None,
