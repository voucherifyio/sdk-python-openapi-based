...
class PromotionsTiersGetResponseBodySummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersGetResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersGetResponseBodySummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersGetResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersGetResponseBodySummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersGetResponseBodySummaryOrders.parse_obj(obj)

        _obj = PromotionsTiersGetResponseBodySummaryOrders.parse_obj({
