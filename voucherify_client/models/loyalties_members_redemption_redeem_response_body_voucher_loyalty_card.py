...
class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.parse_obj(obj)

        _obj = LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard.parse_obj({
