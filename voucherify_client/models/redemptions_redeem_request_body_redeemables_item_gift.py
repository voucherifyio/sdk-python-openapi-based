...
class RedemptionsRedeemRequestBodyRedeemablesItemGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsRedeemRequestBodyRedeemablesItemGift:
        """Create an instance of RedemptionsRedeemRequestBodyRedeemablesItemGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsRedeemRequestBodyRedeemablesItemGift:
        """Create an instance of RedemptionsRedeemRequestBodyRedeemablesItemGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsRedeemRequestBodyRedeemablesItemGift.parse_obj(obj)

        _obj = RedemptionsRedeemRequestBodyRedeemablesItemGift.parse_obj({
