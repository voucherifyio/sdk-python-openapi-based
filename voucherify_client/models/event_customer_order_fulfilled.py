...
class EventCustomerOrderFulfilled(BaseModel):
    """
    Event data object schema for `customer.order.fulfilled`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerOrderFulfilled:
        """Create an instance of EventCustomerOrderFulfilled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerOrderFulfilled:
        """Create an instance of EventCustomerOrderFulfilled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerOrderFulfilled.parse_obj(obj)

        _obj = EventCustomerOrderFulfilled.parse_obj({
