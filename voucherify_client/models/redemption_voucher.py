...
class RedemptionVoucher(BaseModel):
    """
    ...
    gift: Optional[RedemptionVoucherGift] = None
    loyalty_card: Optional[RedemptionVoucherLoyaltyCard] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionVoucher:
        """Create an instance of RedemptionVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionVoucher:
        """Create an instance of RedemptionVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionVoucher.parse_obj(obj)

        _obj = RedemptionVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": RedemptionVoucherGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": RedemptionVoucherLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": RedemptionVoucherPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": RedemptionVoucherRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
