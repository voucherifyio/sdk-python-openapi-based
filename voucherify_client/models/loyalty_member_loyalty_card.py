...
class LoyaltyMemberLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyMemberLoyaltyCard:
        """Create an instance of LoyaltyMemberLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyMemberLoyaltyCard:
        """Create an instance of LoyaltyMemberLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyMemberLoyaltyCard.parse_obj(obj)

        _obj = LoyaltyMemberLoyaltyCard.parse_obj({
