...
class ExportParameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportParameters:
        """Create an instance of ExportParameters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportParameters:
        """Create an instance of ExportParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportParameters.parse_obj(obj)

        _obj = ExportParameters.parse_obj({
            "order": obj.get("order"),
            "fields": obj.get("fields"),
            "filters": ExportParametersFilters.from_dict(obj.get("filters")) if obj.get("filters") is not None else None
        })
        return _obj
