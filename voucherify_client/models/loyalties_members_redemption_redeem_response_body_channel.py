...
class LoyaltiesMembersRedemptionRedeemResponseBodyChannel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersRedemptionRedeemResponseBodyChannel:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyChannel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersRedemptionRedeemResponseBodyChannel:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyChannel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersRedemptionRedeemResponseBodyChannel.parse_obj(obj)

        _obj = LoyaltiesMembersRedemptionRedeemResponseBodyChannel.parse_obj({
