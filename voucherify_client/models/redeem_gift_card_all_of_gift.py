...
class RedeemGiftCardAllOfGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedeemGiftCardAllOfGift:
        """Create an instance of RedeemGiftCardAllOfGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedeemGiftCardAllOfGift:
        """Create an instance of RedeemGiftCardAllOfGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedeemGiftCardAllOfGift.parse_obj(obj)

        _obj = RedeemGiftCardAllOfGift.parse_obj({
