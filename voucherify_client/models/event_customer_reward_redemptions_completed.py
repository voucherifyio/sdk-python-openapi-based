...
class EventCustomerRewardRedemptionsCompleted(BaseModel):
    """
    Event data object schema for `customer.reward_redemptions.completed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRewardRedemptionsCompleted:
        """Create an instance of EventCustomerRewardRedemptionsCompleted from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRewardRedemptionsCompleted:
        """Create an instance of EventCustomerRewardRedemptionsCompleted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRewardRedemptionsCompleted.parse_obj(obj)

        _obj = EventCustomerRewardRedemptionsCompleted.parse_obj({
