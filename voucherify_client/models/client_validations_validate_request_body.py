...
class ClientValidationsValidateRequestBody(BaseModel):
    ...
    redeemables: Optional[conlist(ClientValidationsValidateRequestBodyRedeemablesItem)] = None
    ...
    def from_dict(cls, obj: dict) -> ClientValidationsValidateRequestBody:
        ...
        _obj = ClientValidationsValidateRequestBody.parse_obj({
            "options": ClientValidationsValidateRequestBodyOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "redeemables": [ClientValidationsValidateRequestBodyRedeemablesItem.from_dict(_item) for _item in obj.get("redeemables")] if obj.get("redeemables") is not None else None,
