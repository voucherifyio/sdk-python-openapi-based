...
class RedemptionEntryVoucher(BaseModel):
    """
    ...
    gift: Optional[RedemptionEntryVoucherGift] = None
    loyalty_card: Optional[RedemptionEntryVoucherLoyaltyCard] = None
    ...
    publish: Optional[RedemptionEntryVoucherPublish] = None
    redemption: Optional[RedemptionEntryVoucherRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryVoucher:
        """Create an instance of RedemptionEntryVoucher from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryVoucher:
        """Create an instance of RedemptionEntryVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryVoucher.parse_obj(obj)

        _obj = RedemptionEntryVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": RedemptionEntryVoucherGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": RedemptionEntryVoucherLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": RedemptionEntryVoucherPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": RedemptionEntryVoucherRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
