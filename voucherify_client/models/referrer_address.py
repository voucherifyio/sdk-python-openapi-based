...
class ReferrerAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferrerAddress:
        """Create an instance of ReferrerAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferrerAddress:
        """Create an instance of ReferrerAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReferrerAddress.parse_obj(obj)

        _obj = ReferrerAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
