...
class RedemptionsGetResponseBodyChannel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyChannel:
        """Create an instance of RedemptionsGetResponseBodyChannel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyChannel:
        """Create an instance of RedemptionsGetResponseBodyChannel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyChannel.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyChannel.parse_obj({
