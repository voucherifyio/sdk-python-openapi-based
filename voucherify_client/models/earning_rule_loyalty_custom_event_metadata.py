...
class EarningRuleLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyCustomEventMetadata:
        """Create an instance of EarningRuleLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyCustomEventMetadata:
        """Create an instance of EarningRuleLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = EarningRuleLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
