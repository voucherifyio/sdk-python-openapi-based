...
class RedemptionVoucherPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionVoucherPublish:
        """Create an instance of RedemptionVoucherPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionVoucherPublish:
        """Create an instance of RedemptionVoucherPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionVoucherPublish.parse_obj(obj)

        _obj = RedemptionVoucherPublish.parse_obj({
