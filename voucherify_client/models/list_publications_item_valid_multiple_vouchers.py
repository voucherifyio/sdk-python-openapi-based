...
class ListPublicationsItemValidMultipleVouchers(BaseModel):
    """
    ...
    __properties = ["id", "object", "created_at", "customer_id", "tracking_id", "metadata", "channel", "source_id", "customer", "vouchers_id", "result", "vouchers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListPublicationsItemValidMultipleVouchers:
        """Create an instance of ListPublicationsItemValidMultipleVouchers from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListPublicationsItemValidMultipleVouchers:
        """Create an instance of ListPublicationsItemValidMultipleVouchers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListPublicationsItemValidMultipleVouchers.parse_obj(obj)

        _obj = ListPublicationsItemValidMultipleVouchers.parse_obj({
            "id": obj.get("id"),
