...
class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount:
        """Create an instance of LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
