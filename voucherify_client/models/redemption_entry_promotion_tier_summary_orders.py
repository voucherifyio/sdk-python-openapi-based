...
class RedemptionEntryPromotionTierSummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryPromotionTierSummaryOrders:
        """Create an instance of RedemptionEntryPromotionTierSummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryPromotionTierSummaryOrders:
        """Create an instance of RedemptionEntryPromotionTierSummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryPromotionTierSummaryOrders.parse_obj(obj)

        _obj = RedemptionEntryPromotionTierSummaryOrders.parse_obj({
