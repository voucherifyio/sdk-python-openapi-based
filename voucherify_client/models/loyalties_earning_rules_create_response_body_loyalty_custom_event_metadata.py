...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
