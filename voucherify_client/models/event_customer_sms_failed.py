...
class EventCustomerSmsFailed(BaseModel):
    """
    Event data object schema for `customer.sms.failed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerSmsFailed:
        """Create an instance of EventCustomerSmsFailed from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerSmsFailed:
        """Create an instance of EventCustomerSmsFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerSmsFailed.parse_obj(obj)

        _obj = EventCustomerSmsFailed.parse_obj({
