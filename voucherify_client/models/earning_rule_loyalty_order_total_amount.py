...
class EarningRuleLoyaltyOrderTotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyOrderTotalAmount:
        """Create an instance of EarningRuleLoyaltyOrderTotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyOrderTotalAmount:
        """Create an instance of EarningRuleLoyaltyOrderTotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyOrderTotalAmount.parse_obj(obj)

        _obj = EarningRuleLoyaltyOrderTotalAmount.parse_obj({
            "every": obj.get("every"),
