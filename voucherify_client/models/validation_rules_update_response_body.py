...
class ValidationRulesUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/validation-rules/{validationRuleId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationRulesUpdateResponseBody:
        """Create an instance of ValidationRulesUpdateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationRulesUpdateResponseBody:
        """Create an instance of ValidationRulesUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationRulesUpdateResponseBody.parse_obj(obj)

        _obj = ValidationRulesUpdateResponseBody.parse_obj({
            "name": obj.get("name"),
            "rules": obj.get("rules"),
            "error": ValidationRulesUpdateResponseBodyError.from_dict(obj.get("error")) if obj.get("error") is not None else None,
            "applicable_to": ValidationRulesUpdateResponseBodyApplicableTo.from_dict(obj.get("applicable_to")) if obj.get("applicable_to") is not None else None,
