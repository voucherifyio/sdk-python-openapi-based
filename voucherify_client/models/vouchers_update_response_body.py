...
class VouchersUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/vouchers/{code}`.  # noqa: E501
    """
    ...
    gift: Optional[VouchersUpdateResponseBodyGift] = None
    loyalty_card: Optional[VouchersUpdateResponseBodyLoyaltyCard] = None
    ...
    publish: Optional[VouchersUpdateResponseBodyPublish] = None
    redemption: Optional[VouchersUpdateResponseBodyRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateResponseBody:
        """Create an instance of VouchersUpdateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateResponseBody:
        """Create an instance of VouchersUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateResponseBody.parse_obj(obj)

        _obj = VouchersUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": VouchersUpdateResponseBodyGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VouchersUpdateResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VouchersUpdateResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VouchersUpdateResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
