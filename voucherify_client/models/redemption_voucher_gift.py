...
class RedemptionVoucherGift(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionVoucherGift:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionVoucherGift:
        """Create an instance of RedemptionVoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionVoucherGift.parse_obj(obj)

        _obj = RedemptionVoucherGift.parse_obj({
