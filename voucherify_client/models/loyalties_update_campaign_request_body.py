...
class LoyaltiesUpdateCampaignRequestBody(BaseModel):
    """
    Request body schema for **PUT** `/loyalties/{campaignId}`.  # noqa: E501
    """
    ...
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "loyalty_tiers_expiration", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesUpdateCampaignRequestBody:
        """Create an instance of LoyaltiesUpdateCampaignRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesUpdateCampaignRequestBody:
        """Create an instance of LoyaltiesUpdateCampaignRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesUpdateCampaignRequestBody.parse_obj(obj)

        _obj = LoyaltiesUpdateCampaignRequestBody.parse_obj({
            ...
            "options": LoyaltiesUpdateCampaignRequestBodyOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
