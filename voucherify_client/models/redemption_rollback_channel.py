...
class RedemptionRollbackChannel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRollbackChannel:
        """Create an instance of RedemptionRollbackChannel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRollbackChannel:
        """Create an instance of RedemptionRollbackChannel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRollbackChannel.parse_obj(obj)

        _obj = RedemptionRollbackChannel.parse_obj({
