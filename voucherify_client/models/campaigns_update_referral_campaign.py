...
class CampaignsUpdateReferralCampaign(BaseModel):
    """
    ...
    __properties = ["start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "description", "category", "metadata", "unset_metadata_fields", "category_id", "activity_duration_after_publishing", "join_once", "auto_join", "type", "discount", "referral_program"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsUpdateReferralCampaign:
        """Create an instance of CampaignsUpdateReferralCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsUpdateReferralCampaign:
        """Create an instance of CampaignsUpdateReferralCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsUpdateReferralCampaign.parse_obj(obj)

        _obj = CampaignsUpdateReferralCampaign.parse_obj({
