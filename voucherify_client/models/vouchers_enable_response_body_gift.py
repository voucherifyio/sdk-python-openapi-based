...
class VouchersEnableResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersEnableResponseBodyGift:
        """Create an instance of VouchersEnableResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersEnableResponseBodyGift:
        """Create an instance of VouchersEnableResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersEnableResponseBodyGift.parse_obj(obj)

        _obj = VouchersEnableResponseBodyGift.parse_obj({
