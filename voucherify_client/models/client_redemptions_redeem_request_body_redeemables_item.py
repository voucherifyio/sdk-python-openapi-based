...
class ClientRedemptionsRedeemRequestBodyRedeemablesItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientRedemptionsRedeemRequestBodyRedeemablesItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientRedemptionsRedeemRequestBodyRedeemablesItem:
        """Create an instance of ClientRedemptionsRedeemRequestBodyRedeemablesItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientRedemptionsRedeemRequestBodyRedeemablesItem.parse_obj(obj)

        _obj = ClientRedemptionsRedeemRequestBodyRedeemablesItem.parse_obj({
            "object": obj.get("object"),
            "id": obj.get("id"),
            "gift": ClientRedemptionsRedeemRequestBodyRedeemablesItemGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "reward": ClientRedemptionsRedeemRequestBodyRedeemablesItemReward.from_dict(obj.get("reward")) if obj.get("reward") is not None else None
        })
        return _obj
