...
class ClientValidationsValidateRequestBodyOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientValidationsValidateRequestBodyOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientValidationsValidateRequestBodyOptions:
        """Create an instance of ClientValidationsValidateRequestBodyOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientValidationsValidateRequestBodyOptions.parse_obj(obj)

        _obj = ClientValidationsValidateRequestBodyOptions.parse_obj({
