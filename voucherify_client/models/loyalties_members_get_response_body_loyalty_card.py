...
class LoyaltiesMembersGetResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersGetResponseBodyLoyaltyCard:
        """Create an instance of LoyaltiesMembersGetResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersGetResponseBodyLoyaltyCard:
        """Create an instance of LoyaltiesMembersGetResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersGetResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = LoyaltiesMembersGetResponseBodyLoyaltyCard.parse_obj({
