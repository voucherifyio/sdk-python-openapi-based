...
class RedemptionRewardResultParametersCoin(BaseModel):
    """
    ...
    """
    exchange_ratio: Optional[StrictInt] = Field(None, description="The cash equivalent of the points defined in the `points_ratio` property.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRewardResultParametersCoin:
        """Create an instance of RedemptionRewardResultParametersCoin from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRewardResultParametersCoin:
        """Create an instance of RedemptionRewardResultParametersCoin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRewardResultParametersCoin.parse_obj(obj)

        _obj = RedemptionRewardResultParametersCoin.parse_obj({
