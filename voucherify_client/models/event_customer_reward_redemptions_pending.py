...
class EventCustomerRewardRedemptionsPending(BaseModel):
    """
    Event data object schema for `customer.reward_redemptions.pending`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerRewardRedemptionsPending:
        """Create an instance of EventCustomerRewardRedemptionsPending from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerRewardRedemptionsPending:
        """Create an instance of EventCustomerRewardRedemptionsPending from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerRewardRedemptionsPending.parse_obj(obj)

        _obj = EventCustomerRewardRedemptionsPending.parse_obj({
