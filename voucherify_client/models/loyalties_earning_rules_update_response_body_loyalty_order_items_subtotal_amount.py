...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
