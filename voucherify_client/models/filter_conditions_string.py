...
class FilterConditionsString(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilterConditionsString:
        """Create an instance of FilterConditionsString from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilterConditionsString:
        """Create an instance of FilterConditionsString from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilterConditionsString.parse_obj(obj)

        _obj = FilterConditionsString.parse_obj({
            "var_in": obj.get("$in"),
