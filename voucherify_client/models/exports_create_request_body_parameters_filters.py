...
class ExportsCreateRequestBodyParametersFilters(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportsCreateRequestBodyParametersFilters:
        """Create an instance of ExportsCreateRequestBodyParametersFilters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportsCreateRequestBodyParametersFilters:
        """Create an instance of ExportsCreateRequestBodyParametersFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportsCreateRequestBodyParametersFilters.parse_obj(obj)

        _obj = ExportsCreateRequestBodyParametersFilters.parse_obj({
