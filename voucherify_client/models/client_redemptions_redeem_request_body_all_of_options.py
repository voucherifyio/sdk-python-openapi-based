...
class ClientRedemptionsRedeemRequestBodyAllOfOptions(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientRedemptionsRedeemRequestBodyAllOfOptions:
        """Create an instance of ClientRedemptionsRedeemRequestBodyAllOfOptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientRedemptionsRedeemRequestBodyAllOfOptions:
        """Create an instance of ClientRedemptionsRedeemRequestBodyAllOfOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientRedemptionsRedeemRequestBodyAllOfOptions.parse_obj(obj)

        _obj = ClientRedemptionsRedeemRequestBodyAllOfOptions.parse_obj({
