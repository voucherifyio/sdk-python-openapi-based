...
class LoyaltiesMembersTransfersCreateResponseBodyPublish(BaseModel):
    """
    ...
    __properties = ["object", "count", "entries", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersTransfersCreateResponseBodyPublish:
        """Create an instance of LoyaltiesMembersTransfersCreateResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersTransfersCreateResponseBodyPublish:
        """Create an instance of LoyaltiesMembersTransfersCreateResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersTransfersCreateResponseBodyPublish.parse_obj(obj)

        _obj = LoyaltiesMembersTransfersCreateResponseBodyPublish.parse_obj({
