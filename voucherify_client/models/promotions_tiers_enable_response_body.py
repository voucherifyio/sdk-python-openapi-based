...
class PromotionsTiersEnableResponseBody(BaseModel):
    """
    Response body schema for **POST** `/promotions/tiers/{promotionTierId}/enable`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersEnableResponseBody:
        """Create an instance of PromotionsTiersEnableResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersEnableResponseBody:
        """Create an instance of PromotionsTiersEnableResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersEnableResponseBody.parse_obj(obj)

        _obj = PromotionsTiersEnableResponseBody.parse_obj({
            "id": obj.get("id"),
