...
class PromotionsTiersEnableResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/promotions/tiers/{promotionTierId}/enable`.  # noqa: E501
    """
    ...
    action: Optional[PromotionsTiersEnableResponseBodyAction] = None
    ...
    campaign: Optional[PromotionsTiersEnableResponseBodyCampaign] = None
    ...
    summary: Optional[PromotionsTiersEnableResponseBodySummary] = None
    ...
    def from_dict(cls, obj: dict) -> PromotionsTiersEnableResponseBody:
        ...
        _obj = PromotionsTiersEnableResponseBody.parse_obj({
            ...
            "action": PromotionsTiersEnableResponseBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "metadata": obj.get("metadata"),
            "hierarchy": obj.get("hierarchy"),
            "promotion_id": obj.get("promotion_id"),
            "campaign": PromotionsTiersEnableResponseBodyCampaign.from_dict(obj.get("campaign")) if obj.get("campaign") is not None else None,
            ...
            "summary": PromotionsTiersEnableResponseBodySummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
