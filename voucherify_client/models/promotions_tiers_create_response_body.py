...
class PromotionsTiersCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/promotions/{campaignId}/tiers`.  # noqa: E501
    """
    ...
    action: Optional[PromotionsTiersCreateResponseBodyAction] = None
    ...
    campaign: Optional[PromotionsTiersCreateResponseBodyCampaign] = None
    ...
    summary: Optional[PromotionsTiersCreateResponseBodySummary] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersCreateResponseBody:
        """Create an instance of PromotionsTiersCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersCreateResponseBody:
        """Create an instance of PromotionsTiersCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersCreateResponseBody.parse_obj(obj)

        _obj = PromotionsTiersCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "name": obj.get("name"),
            "banner": obj.get("banner"),
            "action": PromotionsTiersCreateResponseBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
            "metadata": obj.get("metadata"),
            "hierarchy": obj.get("hierarchy"),
            "promotion_id": obj.get("promotion_id"),
            "campaign": PromotionsTiersCreateResponseBodyCampaign.from_dict(obj.get("campaign")) if obj.get("campaign") is not None else None,
            ...
            "summary": PromotionsTiersCreateResponseBodySummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
