...
class EventCustomerOrderCanceled(BaseModel):
    """
    Event data object schema for `customer.order.canceled`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerOrderCanceled:
        """Create an instance of EventCustomerOrderCanceled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerOrderCanceled:
        """Create an instance of EventCustomerOrderCanceled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerOrderCanceled.parse_obj(obj)

        _obj = EventCustomerOrderCanceled.parse_obj({
