...
class RedemptionsGetResponseBodyVoucherRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyVoucherRedemption:
        """Create an instance of RedemptionsGetResponseBodyVoucherRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyVoucherRedemption:
        """Create an instance of RedemptionsGetResponseBodyVoucherRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyVoucherRedemption.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyVoucherRedemption.parse_obj({
