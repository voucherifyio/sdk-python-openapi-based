...
class CampaignsCreateGiftCampaign(BaseModel):
    """
    ...
    campaign_type: Optional[StrictStr] = Field('GIFT_VOUCHERS', description="Type of campaign.")
    voucher: Optional[GiftCampaignVoucher] = None
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in ('GIFT_VOUCHERS',):
            raise ValueError("must be one of enum values ('GIFT_VOUCHERS')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreateGiftCampaign:
        """Create an instance of CampaignsCreateGiftCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreateGiftCampaign:
        """Create an instance of CampaignsCreateGiftCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreateGiftCampaign.parse_obj(obj)

        _obj = CampaignsCreateGiftCampaign.parse_obj({
            "name": obj.get("name"),
            ...
            "campaign_type": obj.get("campaign_type") if obj.get("campaign_type") is not None else 'GIFT_VOUCHERS',
            "voucher": GiftCampaignVoucher.from_dict(obj.get("voucher")) if obj.get("voucher") is not None else None
        })
        return _obj
