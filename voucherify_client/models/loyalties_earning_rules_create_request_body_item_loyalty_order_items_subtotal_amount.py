...
class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
