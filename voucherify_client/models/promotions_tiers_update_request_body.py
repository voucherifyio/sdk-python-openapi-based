...
class PromotionsTiersUpdateRequestBody(BaseModel):
    """
    Request body schema for **PUT** `v1/promotions/tiers/{promotionTierId}`.  # noqa: E501
    """
    ...
    action: Optional[PromotionsTiersUpdateRequestBodyAction] = None
    ...
    category: Optional[StrictStr] = Field(None, description="Assign a new or update the promotion tier's category using name.")
    category_id: Optional[StrictStr] = Field(None, description="Assign a new or update the promotion tier's category using id")
    __properties = ["name", "banner", "action", "metadata", "hierarchy", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "validation_rule_assignments", "category", "category_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersUpdateRequestBody:
        """Create an instance of PromotionsTiersUpdateRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersUpdateRequestBody:
        """Create an instance of PromotionsTiersUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersUpdateRequestBody.parse_obj(obj)

        _obj = PromotionsTiersUpdateRequestBody.parse_obj({
            "name": obj.get("name"),
            "banner": obj.get("banner"),
            "action": PromotionsTiersUpdateRequestBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
