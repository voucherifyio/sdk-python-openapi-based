...
class OrdersUpdateRequestBody(BaseModel):
    """
    Request body schema for **PUT** `v1/orders/{orderId}`.  # noqa: E501
    """
    ...
    __properties = ["source_id", "status", "amount", "initial_amount", "discount_amount", "items", "metadata", "created_at", "referrer_id", "customer", "referrer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersUpdateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersUpdateRequestBody:
        """Create an instance of OrdersUpdateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersUpdateRequestBody.parse_obj(obj)

        _obj = OrdersUpdateRequestBody.parse_obj({
