...
class RewardsUpdateRequestBodyParametersCoin(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardsUpdateRequestBodyParametersCoin:
        """Create an instance of RewardsUpdateRequestBodyParametersCoin from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardsUpdateRequestBodyParametersCoin:
        """Create an instance of RewardsUpdateRequestBodyParametersCoin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardsUpdateRequestBodyParametersCoin.parse_obj(obj)

        _obj = RewardsUpdateRequestBodyParametersCoin.parse_obj({
