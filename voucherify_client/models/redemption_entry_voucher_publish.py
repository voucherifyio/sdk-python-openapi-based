...
class RedemptionEntryVoucherPublish(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryVoucherPublish:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryVoucherPublish:
        """Create an instance of RedemptionEntryVoucherPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryVoucherPublish.parse_obj(obj)

        _obj = RedemptionEntryVoucherPublish.parse_obj({
