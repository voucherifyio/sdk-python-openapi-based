...
class LoyaltiesMembersTiersListResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/loyalties/members/{memberId}/tiers`.  # noqa: E501
    """
    ...
    data: Optional[conlist(LoyaltyTier)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersTiersListResponseBody:
        """Create an instance of LoyaltiesMembersTiersListResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersTiersListResponseBody:
        """Create an instance of LoyaltiesMembersTiersListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersTiersListResponseBody.parse_obj(obj)

        _obj = LoyaltiesMembersTiersListResponseBody.parse_obj({
            ...
            "data": [LoyaltyTier.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
