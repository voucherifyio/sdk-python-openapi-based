...
class VouchersGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/vouchers/{code}`.  # noqa: E501
    """
    ...
    gift: Optional[VouchersGetResponseBodyGift] = None
    loyalty_card: Optional[VouchersGetResponseBodyLoyaltyCard] = None
    ...
    publish: Optional[VouchersGetResponseBodyPublish] = None
    redemption: Optional[VouchersGetResponseBodyRedemption] = None
    ...
    def from_dict(cls, obj: dict) -> VouchersGetResponseBody:
        ...
        _obj = VouchersGetResponseBody.parse_obj({
            ...
            "gift": VouchersGetResponseBodyGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VouchersGetResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VouchersGetResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VouchersGetResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
