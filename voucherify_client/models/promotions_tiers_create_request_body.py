...
class PromotionsTiersCreateRequestBody(BaseModel):
    """
    Request body schema for **POST** `v1/v1/promotions/{campaignId}/tiers`.  # noqa: E501
    """
    ...
    __properties = ["name", "banner", "action", "metadata", "hierarchy", "active", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "validation_rule_assignments", "category", "category_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersCreateRequestBody:
        """Create an instance of PromotionsTiersCreateRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersCreateRequestBody:
        """Create an instance of PromotionsTiersCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersCreateRequestBody.parse_obj(obj)

        _obj = PromotionsTiersCreateRequestBody.parse_obj({
            "name": obj.get("name"),
            "banner": obj.get("banner"),
            "action": PromotionsTiersCreateRequestBodyAction.from_dict(obj.get("action")) if obj.get("action") is not None else None,
