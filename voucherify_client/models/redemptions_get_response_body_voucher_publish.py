...
class RedemptionsGetResponseBodyVoucherPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyVoucherPublish:
        """Create an instance of RedemptionsGetResponseBodyVoucherPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyVoucherPublish:
        """Create an instance of RedemptionsGetResponseBodyVoucherPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyVoucherPublish.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyVoucherPublish.parse_obj({
