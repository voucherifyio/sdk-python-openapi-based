...
class EventCustomerKlaviyoSent(BaseModel):
    """
    Event data object schema for `customer.klaviyo.sent`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerKlaviyoSent:
        """Create an instance of EventCustomerKlaviyoSent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerKlaviyoSent:
        """Create an instance of EventCustomerKlaviyoSent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerKlaviyoSent.parse_obj(obj)

        _obj = EventCustomerKlaviyoSent.parse_obj({
