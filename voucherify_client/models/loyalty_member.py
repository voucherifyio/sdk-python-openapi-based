...
class LoyaltyMember(BaseModel):
    """
    This is an object representing a loyalty member.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyMember:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyMember:
        """Create an instance of LoyaltyMember from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyMember.parse_obj(obj)

        _obj = LoyaltyMember.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": obj.get("gift"),
            "loyalty_card": LoyaltyMemberLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltyMemberPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": LoyaltyMemberRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None
        })
        return _obj
