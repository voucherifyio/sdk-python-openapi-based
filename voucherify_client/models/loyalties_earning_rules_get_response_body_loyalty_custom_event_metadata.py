...
class LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
