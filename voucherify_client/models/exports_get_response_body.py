...
class ExportsGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/exports/{exportId}`.  # noqa: E501
    """
    ...
    result: Optional[ExportsGetResponseBodyResult] = None
    ...
    parameters: Optional[ExportsGetResponseBodyParameters] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportsGetResponseBody:
        """Create an instance of ExportsGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportsGetResponseBody:
        """Create an instance of ExportsGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportsGetResponseBody.parse_obj(obj)

        _obj = ExportsGetResponseBody.parse_obj({
            "id": obj.get("id"),
            "object": obj.get("object") if obj.get("object") is not None else 'export',
            "created_at": obj.get("created_at"),
            "status": obj.get("status"),
            "channel": obj.get("channel"),
            "result": ExportsGetResponseBodyResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            "user_id": obj.get("user_id"),
            "exported_object": obj.get("exported_object"),
            "parameters": ExportsGetResponseBodyParameters.from_dict(obj.get("parameters")) if obj.get("parameters") is not None else None
        })
        return _obj
