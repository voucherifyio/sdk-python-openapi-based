...
class ClientPromotionsTiersListResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/client/v1/promotions/tiers`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientPromotionsTiersListResponseBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientPromotionsTiersListResponseBody:
        """Create an instance of ClientPromotionsTiersListResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientPromotionsTiersListResponseBody.parse_obj(obj)

        _obj = ClientPromotionsTiersListResponseBody.parse_obj({
