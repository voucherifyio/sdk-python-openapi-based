...
class LoyaltiesUpdateCampaignResponseBody(BaseModel):
    """
    Response body schema for **PUT** `/loyalties/{campaignId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesUpdateCampaignResponseBody:
        """Create an instance of LoyaltiesUpdateCampaignResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesUpdateCampaignResponseBody:
        """Create an instance of LoyaltiesUpdateCampaignResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesUpdateCampaignResponseBody.parse_obj(obj)

        _obj = LoyaltiesUpdateCampaignResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
