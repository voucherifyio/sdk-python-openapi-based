...
class PromotionsTiersCreateResponseBodySummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersCreateResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersCreateResponseBodySummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersCreateResponseBodySummaryOrders:
        """Create an instance of PromotionsTiersCreateResponseBodySummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersCreateResponseBodySummaryOrders.parse_obj(obj)

        _obj = PromotionsTiersCreateResponseBodySummaryOrders.parse_obj({
