...
class EarningRuleLoyaltyOrderAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyOrderAmount:
        """Create an instance of EarningRuleLoyaltyOrderAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyOrderAmount:
        """Create an instance of EarningRuleLoyaltyOrderAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyOrderAmount.parse_obj(obj)

        _obj = EarningRuleLoyaltyOrderAmount.parse_obj({
            "every": obj.get("every"),
