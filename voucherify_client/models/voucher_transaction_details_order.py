...
class VoucherTransactionDetailsOrder(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherTransactionDetailsOrder:
        """Create an instance of VoucherTransactionDetailsOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherTransactionDetailsOrder:
        """Create an instance of VoucherTransactionDetailsOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherTransactionDetailsOrder.parse_obj(obj)

        _obj = VoucherTransactionDetailsOrder.parse_obj({
            "id": obj.get("id"),
