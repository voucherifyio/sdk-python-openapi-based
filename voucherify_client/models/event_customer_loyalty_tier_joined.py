...
class EventCustomerLoyaltyTierJoined(BaseModel):
    """
    Event data object schema for `customer.loyalty.tier.joined`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyTierJoined:
        """Create an instance of EventCustomerLoyaltyTierJoined from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyTierJoined:
        """Create an instance of EventCustomerLoyaltyTierJoined from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyTierJoined.parse_obj(obj)

        _obj = EventCustomerLoyaltyTierJoined.parse_obj({
