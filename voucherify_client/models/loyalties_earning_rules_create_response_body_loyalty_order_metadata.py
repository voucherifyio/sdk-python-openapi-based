...
class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderMetadata.parse_obj({
            "every": obj.get("every"),
