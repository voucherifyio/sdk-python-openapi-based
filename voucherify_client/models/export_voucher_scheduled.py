...
class ExportVoucherScheduled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportVoucherScheduled:
        """Create an instance of ExportVoucherScheduled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportVoucherScheduled:
        """Create an instance of ExportVoucherScheduled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportVoucherScheduled.parse_obj(obj)

        _obj = ExportVoucherScheduled.parse_obj({
            "id": obj.get("id"),
