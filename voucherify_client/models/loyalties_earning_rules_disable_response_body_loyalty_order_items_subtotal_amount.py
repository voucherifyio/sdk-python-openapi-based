...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount.parse_obj({
            "every": obj.get("every"),
