...
class EarningRuleSource(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleSource:
        """Create an instance of EarningRuleSource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleSource:
        """Create an instance of EarningRuleSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleSource.parse_obj(obj)

        _obj = EarningRuleSource.parse_obj({
