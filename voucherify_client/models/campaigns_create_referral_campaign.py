...
class CampaignsCreateReferralCampaign(BaseModel):
    """
    ...
    campaign_type: Optional[StrictStr] = Field('REFERRAL_PROGRAM', description="Type of campaign.")
    referral_program: Optional[ReferralProgram] = None
    voucher: Optional[ReferralCampaignVoucher] = None
    __properties = ["name", "description", "type", "join_once", "auto_join", "use_voucher_metadata_schema", "vouchers_count", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "activity_duration_after_publishing", "validation_rules", "category_id", "category", "metadata", "campaign_type", "referral_program", "voucher"]
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in ('REFERRAL_PROGRAM',):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreateReferralCampaign:
        """Create an instance of CampaignsCreateReferralCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreateReferralCampaign:
        """Create an instance of CampaignsCreateReferralCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreateReferralCampaign.parse_obj(obj)

        _obj = CampaignsCreateReferralCampaign.parse_obj({
            "name": obj.get("name"),
            ...
            "voucher": ReferralCampaignVoucher.from_dict(obj.get("voucher")) if obj.get("voucher") is not None else None
        })
        return _obj
