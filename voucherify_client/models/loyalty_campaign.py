...
class LoyaltyCampaign(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyCampaign:
        """Create an instance of LoyaltyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyCampaign:
        """Create an instance of LoyaltyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyCampaign.parse_obj(obj)

        _obj = LoyaltyCampaign.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
