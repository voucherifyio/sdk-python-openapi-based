...
class ClientValidationsValidateResponseBodyRedeemablesItemResultDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientValidationsValidateResponseBodyRedeemablesItemResultDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientValidationsValidateResponseBodyRedeemablesItemResultDetails:
        """Create an instance of ClientValidationsValidateResponseBodyRedeemablesItemResultDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientValidationsValidateResponseBodyRedeemablesItemResultDetails.parse_obj(obj)

        _obj = ClientValidationsValidateResponseBodyRedeemablesItemResultDetails.parse_obj({
            "key": obj.get("key"),
