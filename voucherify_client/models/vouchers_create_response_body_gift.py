...
class VouchersCreateResponseBodyGift(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersCreateResponseBodyGift:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersCreateResponseBodyGift:
        """Create an instance of VouchersCreateResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersCreateResponseBodyGift.parse_obj(obj)

        _obj = VouchersCreateResponseBodyGift.parse_obj({
