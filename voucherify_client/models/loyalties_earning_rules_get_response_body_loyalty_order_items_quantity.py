...
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
