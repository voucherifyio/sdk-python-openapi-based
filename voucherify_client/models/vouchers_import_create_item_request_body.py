...
class VouchersImportCreateItemRequestBody(BaseModel):
    ...
    __properties = ["code", "redemption", "active", "metadata", "category", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "additional_info", "type", "gift", "discount"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('GIFT_VOUCHER', 'DISCOUNT_VOUCHER',):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersImportCreateItemRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersImportCreateItemRequestBody:
        """Create an instance of VouchersImportCreateItemRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersImportCreateItemRequestBody.parse_obj(obj)

        _obj = VouchersImportCreateItemRequestBody.parse_obj({
            "code": obj.get("code"),
            "redemption": VouchersImportCreateItemRequestBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
