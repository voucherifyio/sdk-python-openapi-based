...
class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
