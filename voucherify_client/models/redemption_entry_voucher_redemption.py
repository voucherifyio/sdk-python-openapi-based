...
class RedemptionEntryVoucherRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryVoucherRedemption:
        """Create an instance of RedemptionEntryVoucherRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryVoucherRedemption:
        """Create an instance of RedemptionEntryVoucherRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryVoucherRedemption.parse_obj(obj)

        _obj = RedemptionEntryVoucherRedemption.parse_obj({
