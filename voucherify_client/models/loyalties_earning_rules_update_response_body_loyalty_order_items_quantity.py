...
class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
