...
class CampaignsVouchersCreateResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateResponseBodyRedemption:
        """Create an instance of CampaignsVouchersCreateResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateResponseBodyRedemption:
        """Create an instance of CampaignsVouchersCreateResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateResponseBodyRedemption.parse_obj(obj)

        _obj = CampaignsVouchersCreateResponseBodyRedemption.parse_obj({
