...
class EarningRule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRule:
        """Create an instance of EarningRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRule.parse_obj(obj)

        _obj = EarningRule.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "loyalty": EarningRuleLoyalty.from_dict(obj.get("loyalty")) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": EarningRuleCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
            "segment": EarningRuleSegment.from_dict(obj.get("segment")) if obj.get("segment") is not None else None,
            "loyalty_tier": EarningRuleLoyaltyTier.from_dict(obj.get("loyalty_tier")) if obj.get("loyalty_tier") is not None else None,
            "source": EarningRuleSource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
