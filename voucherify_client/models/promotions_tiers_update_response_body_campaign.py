...
class PromotionsTiersUpdateResponseBodyCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionsTiersUpdateResponseBodyCampaign:
        """Create an instance of PromotionsTiersUpdateResponseBodyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionsTiersUpdateResponseBodyCampaign:
        """Create an instance of PromotionsTiersUpdateResponseBodyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionsTiersUpdateResponseBodyCampaign.parse_obj(obj)

        _obj = PromotionsTiersUpdateResponseBodyCampaign.parse_obj({
            "id": obj.get("id"),
