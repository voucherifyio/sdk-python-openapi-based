...
class VouchersDisableResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersDisableResponseBodyPublish:
        """Create an instance of VouchersDisableResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersDisableResponseBodyPublish:
        """Create an instance of VouchersDisableResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersDisableResponseBodyPublish.parse_obj(obj)

        _obj = VouchersDisableResponseBodyPublish.parse_obj({
