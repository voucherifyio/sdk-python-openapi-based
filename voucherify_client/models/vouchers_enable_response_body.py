...
class VouchersEnableResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/vouchers/{code}/enable`.  # noqa: E501
    """
    ...
    gift: Optional[VouchersEnableResponseBodyGift] = None
    loyalty_card: Optional[VouchersEnableResponseBodyLoyaltyCard] = None
    ...
    publish: Optional[VouchersEnableResponseBodyPublish] = None
    redemption: Optional[VouchersEnableResponseBodyRedemption] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersEnableResponseBody:
        """Create an instance of VouchersEnableResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersEnableResponseBody:
        """Create an instance of VouchersEnableResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersEnableResponseBody.parse_obj(obj)

        _obj = VouchersEnableResponseBody.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": VouchersEnableResponseBodyGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VouchersEnableResponseBodyLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VouchersEnableResponseBodyPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VouchersEnableResponseBodyRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
