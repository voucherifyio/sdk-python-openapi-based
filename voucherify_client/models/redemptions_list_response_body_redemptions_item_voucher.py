...
class RedemptionsListResponseBodyRedemptionsItemVoucher(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemVoucher:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemVoucher:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemVoucher from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemVoucher.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemVoucher.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": RedemptionsListResponseBodyRedemptionsItemVoucherGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": RedemptionsListResponseBodyRedemptionsItemVoucherLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": RedemptionsListResponseBodyRedemptionsItemVoucherPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": RedemptionsListResponseBodyRedemptionsItemVoucherRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
