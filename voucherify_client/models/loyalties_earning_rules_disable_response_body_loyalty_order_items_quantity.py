...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
