...
class LoyaltiesEarningRulesCreateResponseBody(BaseModel):
    """
    Response body schema for **POST** `v1/loyalties/{campaignId}/earning-rules`.  # noqa: E501
    """
    ...
    loyalty: Optional[LoyaltiesEarningRulesCreateResponseBodyLoyalty] = None
    event: Optional[StrictStr] = None
    custom_event: Optional[LoyaltiesEarningRulesCreateResponseBodyCustomEvent] = None
    segment: Optional[LoyaltiesEarningRulesCreateResponseBodySegment] = None
    loyalty_tier: Optional[LoyaltiesEarningRulesCreateResponseBodyLoyaltyTier] = None
    source: Optional[LoyaltiesEarningRulesCreateResponseBodySource] = None
    ...
    __properties = ["id", "created_at", "loyalty", "event", "custom_event", "segment", "loyalty_tier", "source", "object", "automation_id", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "metadata", "validation_rule_id", "updated_at", "active"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesCreateResponseBody:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesCreateResponseBody:
        """Create an instance of LoyaltiesEarningRulesCreateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesCreateResponseBody.parse_obj(obj)

        _obj = LoyaltiesEarningRulesCreateResponseBody.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "loyalty": LoyaltiesEarningRulesCreateResponseBodyLoyalty.from_dict(obj.get("loyalty")) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": LoyaltiesEarningRulesCreateResponseBodyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
            "segment": LoyaltiesEarningRulesCreateResponseBodySegment.from_dict(obj.get("segment")) if obj.get("segment") is not None else None,
            "loyalty_tier": LoyaltiesEarningRulesCreateResponseBodyLoyaltyTier.from_dict(obj.get("loyalty_tier")) if obj.get("loyalty_tier") is not None else None,
            "source": LoyaltiesEarningRulesCreateResponseBodySource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
