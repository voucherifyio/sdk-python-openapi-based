...
class ClientRedemptionsRedeemRequestBodyOptions(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientRedemptionsRedeemRequestBodyOptions:
        """Create an instance of ClientRedemptionsRedeemRequestBodyOptions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientRedemptionsRedeemRequestBodyOptions:
        """Create an instance of ClientRedemptionsRedeemRequestBodyOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientRedemptionsRedeemRequestBodyOptions.parse_obj(obj)

        _obj = ClientRedemptionsRedeemRequestBodyOptions.parse_obj({
