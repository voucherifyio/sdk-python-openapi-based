...
class CustomersUpdateInBulkRequestBody(BaseModel):
    """
    Request body schema for **POST** `v1/customers/bulk/async`.  # noqa: E501
    """
    source_id: Optional[StrictStr] = Field(None, description="Unique customer source ID.")
    ...
    address: Optional[CustomersUpdateInBulkRequestBodyAddress] = None
    ...
    __properties = ["source_id", "name", "description", "email", "phone", "birthday", "birthdate", "address", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersUpdateInBulkRequestBody:
        """Create an instance of CustomersUpdateInBulkRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersUpdateInBulkRequestBody:
        """Create an instance of CustomersUpdateInBulkRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersUpdateInBulkRequestBody.parse_obj(obj)

        _obj = CustomersUpdateInBulkRequestBody.parse_obj({
            ...
            "address": CustomersUpdateInBulkRequestBodyAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
