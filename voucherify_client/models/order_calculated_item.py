...
class OrderCalculatedItem(BaseModel):
    ...
    OrderCalculatedItem
    """
    id: Optional[StrictStr] = Field(None, description="Unique identifier of the order line item.")
    ...
    applied_discount_quantity: Optional[StrictInt] = Field(None, description="Number of the discounted items applied in the transaction.")
    applied_quantity: Optional[StrictInt] = Field(None, description="Quantity of items changed by the application of a new quantity items. It can be positive when an item is added or negative if an item is replaced.")
    applied_quantity_amount: Optional[StrictInt] = Field(None, description="Amount for the items changed by the application of a new quantity items. It can be positive when an item is added or negative if an item is replaced.")
    ...
    object: Optional[StrictStr] = Field('order_item', description="The type of the object represented by JSON.")
    ...
    __properties = ["id", "sku_id", "product_id", "related_object", "source_id", "quantity", "discount_quantity", "initial_quantity", "amount", "discount_amount", "applied_discount_amount", "applied_discount_quantity", "applied_quantity", "applied_quantity_amount", "initial_amount", "price", "subtotal_amount", "product", "sku", "object", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderCalculatedItem:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.applied_discount_quantity is None and "applied_discount_quantity" in self.__fields_set__:
            _dict['applied_discount_quantity'] = None

        # set to None if applied_quantity (nullable) is None
        # and __fields_set__ contains the field
        if self.applied_quantity is None and "applied_quantity" in self.__fields_set__:
            _dict['applied_quantity'] = None

        # set to None if applied_quantity_amount (nullable) is None
        # and __fields_set__ contains the field
        if self.applied_quantity_amount is None and "applied_quantity_amount" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderCalculatedItem:
        """Create an instance of OrderCalculatedItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderCalculatedItem.parse_obj(obj)

        _obj = OrderCalculatedItem.parse_obj({
            "id": obj.get("id"),
            ...
            "product": OrderCalculatedItemProduct.from_dict(obj.get("product")) if obj.get("product") is not None else None,
            "sku": OrderCalculatedItemSku.from_dict(obj.get("sku")) if obj.get("sku") is not None else None,
