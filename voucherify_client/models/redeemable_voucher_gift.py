...
class RedeemableVoucherGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedeemableVoucherGift:
        """Create an instance of RedeemableVoucherGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedeemableVoucherGift:
        """Create an instance of RedeemableVoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedeemableVoucherGift.parse_obj(obj)

        _obj = RedeemableVoucherGift.parse_obj({
