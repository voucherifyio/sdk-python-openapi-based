...
class RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemRelatedRedemptionsRollbacksItem.parse_obj({
            "id": obj.get("id"),
