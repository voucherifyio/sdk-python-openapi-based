...
class RedemptionEntryVoucherLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryVoucherLoyaltyCard:
        """Create an instance of RedemptionEntryVoucherLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryVoucherLoyaltyCard:
        """Create an instance of RedemptionEntryVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryVoucherLoyaltyCard.parse_obj(obj)

        _obj = RedemptionEntryVoucherLoyaltyCard.parse_obj({
