...
class SkusGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/skus/{skuId}`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SkusGetResponseBody:
        """Create an instance of SkusGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SkusGetResponseBody:
        """Create an instance of SkusGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SkusGetResponseBody.parse_obj(obj)

        _obj = SkusGetResponseBody.parse_obj({
            "id": obj.get("id"),
