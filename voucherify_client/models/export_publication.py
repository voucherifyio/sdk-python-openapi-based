...
class ExportPublication(BaseModel):
    """
    ExportPublication
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportPublication:
        """Create an instance of ExportPublication from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportPublication:
        """Create an instance of ExportPublication from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportPublication.parse_obj(obj)

        _obj = ExportPublication.parse_obj({
            "id": obj.get("id"),
