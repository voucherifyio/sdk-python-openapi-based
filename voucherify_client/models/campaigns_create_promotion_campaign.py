...
class CampaignsCreatePromotionCampaign(BaseModel):
    """
    ...
    campaign_type: Optional[StrictStr] = Field('PROMOTION', description="Type of campaign.")
    promotion: Optional[SchemaThatContainsUniquePropertiesForPromotionCampaignPromotion] = None
    __properties = ["name", "description", "type", "join_once", "auto_join", "use_voucher_metadata_schema", "vouchers_count", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "activity_duration_after_publishing", "validation_rules", "category_id", "category", "metadata", "campaign_type", "promotion"]
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in ('PROMOTION',):
            raise ValueError("must be one of enum values ('PROMOTION')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreatePromotionCampaign:
        """Create an instance of CampaignsCreatePromotionCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreatePromotionCampaign:
        """Create an instance of CampaignsCreatePromotionCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreatePromotionCampaign.parse_obj(obj)

        _obj = CampaignsCreatePromotionCampaign.parse_obj({
            "name": obj.get("name"),
            ...
            "campaign_type": obj.get("campaign_type") if obj.get("campaign_type") is not None else 'PROMOTION',
            "promotion": SchemaThatContainsUniquePropertiesForPromotionCampaignPromotion.from_dict(obj.get("promotion")) if obj.get("promotion") is not None else None
        })
        return _obj
