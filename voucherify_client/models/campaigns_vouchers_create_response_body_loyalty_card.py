...
class CampaignsVouchersCreateResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateResponseBodyLoyaltyCard:
        """Create an instance of CampaignsVouchersCreateResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateResponseBodyLoyaltyCard:
        """Create an instance of CampaignsVouchersCreateResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = CampaignsVouchersCreateResponseBodyLoyaltyCard.parse_obj({
