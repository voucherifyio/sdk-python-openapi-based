...
class LoyaltiesEarningRulesUpdateResponseBodySource(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesUpdateResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodySource from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesUpdateResponseBodySource:
        """Create an instance of LoyaltiesEarningRulesUpdateResponseBodySource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesUpdateResponseBodySource.parse_obj(obj)

        _obj = LoyaltiesEarningRulesUpdateResponseBodySource.parse_obj({
