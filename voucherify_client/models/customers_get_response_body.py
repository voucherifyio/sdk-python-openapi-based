...
class CustomersGetResponseBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersGetResponseBody:
        """Create an instance of CustomersGetResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersGetResponseBody:
        """Create an instance of CustomersGetResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersGetResponseBody.parse_obj(obj)

        _obj = CustomersGetResponseBody.parse_obj({
            "id": obj.get("id"),
