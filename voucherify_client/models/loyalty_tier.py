...
class LoyaltyTier(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> LoyaltyTier:
        ...
        _obj = LoyaltyTier.parse_obj({
            ...
            "points": LoyaltyTierPoints.from_dict(obj.get("points")) if obj.get("points") is not None else None,
            "id": obj.get("id"),
            "campaign_id": obj.get("campaign_id"),
            "metadata": obj.get("metadata"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "config": LoyaltyTierConfig.from_dict(obj.get("config")) if obj.get("config") is not None else None,
