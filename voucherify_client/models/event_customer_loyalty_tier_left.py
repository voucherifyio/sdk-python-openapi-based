...
class EventCustomerLoyaltyTierLeft(BaseModel):
    """
    Event data object schema for `customer.loyalty.tier.left`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerLoyaltyTierLeft:
        """Create an instance of EventCustomerLoyaltyTierLeft from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerLoyaltyTierLeft:
        """Create an instance of EventCustomerLoyaltyTierLeft from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerLoyaltyTierLeft.parse_obj(obj)

        _obj = EventCustomerLoyaltyTierLeft.parse_obj({
