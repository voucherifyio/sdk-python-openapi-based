...
class EventCustomerEmailSent(BaseModel):
    """
    Event data object schema for `customer.email.sent`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerEmailSent:
        """Create an instance of EventCustomerEmailSent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerEmailSent:
        """Create an instance of EventCustomerEmailSent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerEmailSent.parse_obj(obj)

        _obj = EventCustomerEmailSent.parse_obj({
