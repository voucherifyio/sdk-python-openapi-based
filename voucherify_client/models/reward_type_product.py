...
class RewardTypeProduct(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardTypeProduct:
        """Create an instance of RewardTypeProduct from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardTypeProduct:
        """Create an instance of RewardTypeProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardTypeProduct.parse_obj(obj)

        _obj = RewardTypeProduct.parse_obj({
            "id": obj.get("id"),
