...
class OrdersCreateRequestBody(BaseModel):
    """
    Request body schema for **POST** `/orders`.  # noqa: E501
    """
    ...
    __properties = ["id", "source_id", "status", "amount", "discount_amount", "initial_amount", "items", "customer", "customer_id", "referrer", "referrer_id", "metadata"]
