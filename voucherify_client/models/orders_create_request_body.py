...
class OrdersCreateRequestBody(BaseModel):
    """
    Request body schema for **POST** `v1/orders`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersCreateRequestBody:
        """Create an instance of OrdersCreateRequestBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersCreateRequestBody:
        """Create an instance of OrdersCreateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersCreateRequestBody.parse_obj(obj)

        _obj = OrdersCreateRequestBody.parse_obj({
            "id": obj.get("id"),
