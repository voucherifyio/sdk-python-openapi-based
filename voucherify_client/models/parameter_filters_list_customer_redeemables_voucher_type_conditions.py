...
class ParameterFiltersListCustomerRedeemablesVoucherTypeConditions(BaseModel):
    """
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('GIFT_VOUCHER', 'DISCOUNT_VOUCHER', 'LOYALTY_CARD',):
                raise ValueError("each list item must be one of ('GIFT_VOUCHER', 'DISCOUNT_VOUCHER', 'LOYALTY_CARD')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParameterFiltersListCustomerRedeemablesVoucherTypeConditions:
        """Create an instance of ParameterFiltersListCustomerRedeemablesVoucherTypeConditions from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParameterFiltersListCustomerRedeemablesVoucherTypeConditions:
        """Create an instance of ParameterFiltersListCustomerRedeemablesVoucherTypeConditions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParameterFiltersListCustomerRedeemablesVoucherTypeConditions.parse_obj(obj)

        _obj = ParameterFiltersListCustomerRedeemablesVoucherTypeConditions.parse_obj({
            "var_in": obj.get("$in"),
