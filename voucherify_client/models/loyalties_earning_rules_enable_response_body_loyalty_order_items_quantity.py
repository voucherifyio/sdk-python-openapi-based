...
class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity.parse_obj(obj)

        _obj = LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity.parse_obj({
            "every": obj.get("every"),
