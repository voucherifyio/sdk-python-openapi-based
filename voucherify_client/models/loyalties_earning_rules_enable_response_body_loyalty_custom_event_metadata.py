...
class LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
