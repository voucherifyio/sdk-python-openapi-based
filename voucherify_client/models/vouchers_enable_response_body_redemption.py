...
class VouchersEnableResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersEnableResponseBodyRedemption:
        """Create an instance of VouchersEnableResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersEnableResponseBodyRedemption:
        """Create an instance of VouchersEnableResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersEnableResponseBodyRedemption.parse_obj(obj)

        _obj = VouchersEnableResponseBodyRedemption.parse_obj({
