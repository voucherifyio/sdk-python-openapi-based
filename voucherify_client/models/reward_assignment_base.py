...
class RewardAssignmentBase(BaseModel):
    """
    ...
    __properties = ["id", "reward_id", "created_at", "updated_at", "object", "related_object_id", "related_object_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardAssignmentBase:
        """Create an instance of RewardAssignmentBase from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardAssignmentBase:
        """Create an instance of RewardAssignmentBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardAssignmentBase.parse_obj(obj)

        _obj = RewardAssignmentBase.parse_obj({
            "id": obj.get("id"),
