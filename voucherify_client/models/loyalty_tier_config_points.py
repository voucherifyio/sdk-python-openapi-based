...
class LoyaltyTierConfigPoints(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltyTierConfigPoints:
        """Create an instance of LoyaltyTierConfigPoints from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltyTierConfigPoints:
        """Create an instance of LoyaltyTierConfigPoints from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltyTierConfigPoints.parse_obj(obj)

        _obj = LoyaltyTierConfigPoints.parse_obj({
