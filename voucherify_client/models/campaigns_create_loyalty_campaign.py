...
class CampaignsCreateLoyaltyCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreateLoyaltyCampaign:
        """Create an instance of CampaignsCreateLoyaltyCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreateLoyaltyCampaign:
        """Create an instance of CampaignsCreateLoyaltyCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreateLoyaltyCampaign.parse_obj(obj)

        _obj = CampaignsCreateLoyaltyCampaign.parse_obj({
            "name": obj.get("name"),
