...
class CustomersCreateResponseBodyAddress(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomersCreateResponseBodyAddress:
        """Create an instance of CustomersCreateResponseBodyAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomersCreateResponseBodyAddress:
        """Create an instance of CustomersCreateResponseBodyAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomersCreateResponseBodyAddress.parse_obj(obj)

        _obj = CustomersCreateResponseBodyAddress.parse_obj({
            "city": obj.get("city"),
            "state": obj.get("state"),
