...
class ValidationsValidateRequestBody(BaseModel):
    """
    Response body schema for **POST** `v1/validations`.  # noqa: E501
    """
    options: Optional[ValidationsValidateRequestBodyOptions] = None
    redeemables: Optional[conlist(ValidationsValidateRequestBodyRedeemablesItem)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationsValidateRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationsValidateRequestBody:
        """Create an instance of ValidationsValidateRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationsValidateRequestBody.parse_obj(obj)

        _obj = ValidationsValidateRequestBody.parse_obj({
            "options": ValidationsValidateRequestBodyOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "redeemables": [ValidationsValidateRequestBodyRedeemablesItem.from_dict(_item) for _item in obj.get("redeemables")] if obj.get("redeemables") is not None else None,
