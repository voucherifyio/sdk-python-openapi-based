...
class CampaignsCreateDiscountCouponsCampaign(BaseModel):
    """
    ...
    campaign_type: Optional[StrictStr] = Field('DISCOUNT_COUPONS', description="Type of campaign.")
    voucher: Optional[DiscountCouponsCampaignVoucher] = None
    ...
    def campaign_type_validate_enum(cls, value):
        ...
        if value not in ('DISCOUNT_COUPONS',):
            raise ValueError("must be one of enum values ('DISCOUNT_COUPONS')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsCreateDiscountCouponsCampaign:
        """Create an instance of CampaignsCreateDiscountCouponsCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsCreateDiscountCouponsCampaign:
        """Create an instance of CampaignsCreateDiscountCouponsCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsCreateDiscountCouponsCampaign.parse_obj(obj)

        _obj = CampaignsCreateDiscountCouponsCampaign.parse_obj({
            "name": obj.get("name"),
            ...
            "voucher": DiscountCouponsCampaignVoucher.from_dict(obj.get("voucher")) if obj.get("voucher") is not None else None
        })
        return _obj
