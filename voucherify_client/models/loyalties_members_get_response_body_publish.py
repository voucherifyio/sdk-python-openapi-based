...
class LoyaltiesMembersGetResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesMembersGetResponseBodyPublish:
        """Create an instance of LoyaltiesMembersGetResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesMembersGetResponseBodyPublish:
        """Create an instance of LoyaltiesMembersGetResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesMembersGetResponseBodyPublish.parse_obj(obj)

        _obj = LoyaltiesMembersGetResponseBodyPublish.parse_obj({
