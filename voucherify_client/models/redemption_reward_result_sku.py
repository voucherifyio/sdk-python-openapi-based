...
class RedemptionRewardResultSku(BaseModel):
    """
    Defines of the sku.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionRewardResultSku:
        """Create an instance of RedemptionRewardResultSku from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionRewardResultSku:
        """Create an instance of RedemptionRewardResultSku from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionRewardResultSku.parse_obj(obj)

        _obj = RedemptionRewardResultSku.parse_obj({
            "id": obj.get("id"),
