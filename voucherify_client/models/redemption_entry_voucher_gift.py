...
class RedemptionEntryVoucherGift(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryVoucherGift:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryVoucherGift:
        """Create an instance of RedemptionEntryVoucherGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryVoucherGift.parse_obj(obj)

        _obj = RedemptionEntryVoucherGift.parse_obj({
