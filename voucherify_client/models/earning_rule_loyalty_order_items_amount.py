...
class EarningRuleLoyaltyOrderItemsAmount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningRuleLoyaltyOrderItemsAmount:
        """Create an instance of EarningRuleLoyaltyOrderItemsAmount from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningRuleLoyaltyOrderItemsAmount:
        """Create an instance of EarningRuleLoyaltyOrderItemsAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningRuleLoyaltyOrderItemsAmount.parse_obj(obj)

        _obj = EarningRuleLoyaltyOrderItemsAmount.parse_obj({
            "every": obj.get("every"),
