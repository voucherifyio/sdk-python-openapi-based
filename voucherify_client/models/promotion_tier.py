...
class PromotionTier(BaseModel):
    """
    This is an object representing a promotion tier. Promotion tiers are always assigned to a campaign and cannot be used standalone.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionTier:
        """Create an instance of PromotionTier from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionTier:
        """Create an instance of PromotionTier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionTier.parse_obj(obj)

        _obj = PromotionTier.parse_obj({
            "id": obj.get("id"),
