...
class VoucherTransactionsFilters(BaseModel):
    """
    List of available fields and filters that can be exported with gift card or loyalty card transactions along with the sorting order of the returned data.  # noqa: E501
    """
    ...
    filters: VoucherTransactionsExportFilterConditions = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherTransactionsFilters:
        """Create an instance of VoucherTransactionsFilters from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherTransactionsFilters:
        """Create an instance of VoucherTransactionsFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherTransactionsFilters.parse_obj(obj)

        _obj = VoucherTransactionsFilters.parse_obj({
            "order": obj.get("order"),
            "fields": obj.get("fields"),
            "filters": VoucherTransactionsExportFilterConditions.from_dict(obj.get("filters")) if obj.get("filters") is not None else None
        })
        return _obj
