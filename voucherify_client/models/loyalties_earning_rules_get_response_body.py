...
class LoyaltiesEarningRulesGetResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/loyalties/{campaignId}/earning-rules/{earningRuleId}`.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesGetResponseBody:
        ...
        _obj = LoyaltiesEarningRulesGetResponseBody.parse_obj({
            ...
            "loyalty": LoyaltiesEarningRulesGetResponseBodyLoyalty.from_dict(obj.get("loyalty")) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": LoyaltiesEarningRulesGetResponseBodyCustomEvent.from_dict(obj.get("custom_event")) if obj.get("custom_event") is not None else None,
            "segment": LoyaltiesEarningRulesGetResponseBodySegment.from_dict(obj.get("segment")) if obj.get("segment") is not None else None,
            "loyalty_tier": LoyaltiesEarningRulesGetResponseBodyLoyaltyTier.from_dict(obj.get("loyalty_tier")) if obj.get("loyalty_tier") is not None else None,
            "source": LoyaltiesEarningRulesGetResponseBodySource.from_dict(obj.get("source")) if obj.get("source") is not None else None,
