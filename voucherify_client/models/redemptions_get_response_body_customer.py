...
class RedemptionsGetResponseBodyCustomer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsGetResponseBodyCustomer:
        """Create an instance of RedemptionsGetResponseBodyCustomer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsGetResponseBodyCustomer:
        """Create an instance of RedemptionsGetResponseBodyCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsGetResponseBodyCustomer.parse_obj(obj)

        _obj = RedemptionsGetResponseBodyCustomer.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "email": obj.get("email"),
