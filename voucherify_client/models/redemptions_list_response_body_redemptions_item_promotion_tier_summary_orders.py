...
class RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders.parse_obj({
