...
class EventCustomerEmailFailed(BaseModel):
    """
    Event data object schema for `customer.email.failed`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerEmailFailed:
        """Create an instance of EventCustomerEmailFailed from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerEmailFailed:
        """Create an instance of EventCustomerEmailFailed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerEmailFailed.parse_obj(obj)

        _obj = EventCustomerEmailFailed.parse_obj({
