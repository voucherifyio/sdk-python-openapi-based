...
class EventCustomerBrazeSent(BaseModel):
    """
    Event data object schema for `customer.braze.sent`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerBrazeSent:
        """Create an instance of EventCustomerBrazeSent from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerBrazeSent:
        """Create an instance of EventCustomerBrazeSent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerBrazeSent.parse_obj(obj)

        _obj = EventCustomerBrazeSent.parse_obj({
