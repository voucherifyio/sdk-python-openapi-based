...
class VoucherWithCategoriesPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherWithCategoriesPublish:
        """Create an instance of VoucherWithCategoriesPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherWithCategoriesPublish:
        """Create an instance of VoucherWithCategoriesPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherWithCategoriesPublish.parse_obj(obj)

        _obj = VoucherWithCategoriesPublish.parse_obj({
