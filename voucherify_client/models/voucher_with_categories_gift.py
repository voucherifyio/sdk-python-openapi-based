...
class VoucherWithCategoriesGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherWithCategoriesGift:
        """Create an instance of VoucherWithCategoriesGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherWithCategoriesGift:
        """Create an instance of VoucherWithCategoriesGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherWithCategoriesGift.parse_obj(obj)

        _obj = VoucherWithCategoriesGift.parse_obj({
