...
class CampaignsVouchersCreateCombinedResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateCombinedResponseBodyGift:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateCombinedResponseBodyGift:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateCombinedResponseBodyGift.parse_obj(obj)

        _obj = CampaignsVouchersCreateCombinedResponseBodyGift.parse_obj({
