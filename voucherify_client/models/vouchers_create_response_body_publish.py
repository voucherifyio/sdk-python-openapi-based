...
class VouchersCreateResponseBodyPublish(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersCreateResponseBodyPublish:
        """Create an instance of VouchersCreateResponseBodyPublish from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersCreateResponseBodyPublish:
        """Create an instance of VouchersCreateResponseBodyPublish from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersCreateResponseBodyPublish.parse_obj(obj)

        _obj = VouchersCreateResponseBodyPublish.parse_obj({
