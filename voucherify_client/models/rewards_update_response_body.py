...
class RewardsUpdateResponseBody(BaseModel):
    """
    Response body schema for **PUT** `v1/rewards/{rewardId}`.  # noqa: E501
    """
    ...
    attributes: Optional[RewardsUpdateResponseBodyAttributes] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RewardsUpdateResponseBody:
        """Create an instance of RewardsUpdateResponseBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RewardsUpdateResponseBody:
        """Create an instance of RewardsUpdateResponseBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RewardsUpdateResponseBody.parse_obj(obj)

        _obj = RewardsUpdateResponseBody.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "stock": obj.get("stock"),
            "redeemed": obj.get("redeemed"),
            "attributes": RewardsUpdateResponseBodyAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
