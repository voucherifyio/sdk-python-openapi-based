...
class CustomersCreateRequestBody(BaseModel):
    """
    Request body schema for **POST** `v1/customers`.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> CustomersCreateRequestBody:
        ...
        _obj = CustomersCreateRequestBody.parse_obj({
            ...
            "address": CustomersCreateRequestBodyAddress.from_dict(obj.get("address")) if obj.get("address") is not None else None,
