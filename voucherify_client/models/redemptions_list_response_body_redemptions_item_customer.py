...
class RedemptionsListResponseBodyRedemptionsItemCustomer(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionsListResponseBodyRedemptionsItemCustomer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionsListResponseBodyRedemptionsItemCustomer:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionsListResponseBodyRedemptionsItemCustomer.parse_obj(obj)

        _obj = RedemptionsListResponseBodyRedemptionsItemCustomer.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "email": obj.get("email"),
