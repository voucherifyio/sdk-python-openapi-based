...
class ValidationsValidateResponseBodyRedeemablesItemResultDiscount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidationsValidateResponseBodyRedeemablesItemResultDiscount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidationsValidateResponseBodyRedeemablesItemResultDiscount:
        """Create an instance of ValidationsValidateResponseBodyRedeemablesItemResultDiscount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidationsValidateResponseBodyRedeemablesItemResultDiscount.parse_obj(obj)

        _obj = ValidationsValidateResponseBodyRedeemablesItemResultDiscount.parse_obj({
            "type": obj.get("type"),
            ...
            "product": ValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct.from_dict(obj.get("product")) if obj.get("product") is not None else None,
