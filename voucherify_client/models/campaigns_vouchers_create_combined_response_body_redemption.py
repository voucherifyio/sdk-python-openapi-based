...
class CampaignsVouchersCreateCombinedResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateCombinedResponseBodyRedemption:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateCombinedResponseBodyRedemption:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateCombinedResponseBodyRedemption.parse_obj(obj)

        _obj = CampaignsVouchersCreateCombinedResponseBodyRedemption.parse_obj({
