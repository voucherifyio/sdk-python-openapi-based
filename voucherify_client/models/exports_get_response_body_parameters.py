...
class ExportsGetResponseBodyParameters(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportsGetResponseBodyParameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportsGetResponseBodyParameters:
        """Create an instance of ExportsGetResponseBodyParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportsGetResponseBodyParameters.parse_obj(obj)

        _obj = ExportsGetResponseBodyParameters.parse_obj({
            "order": obj.get("order"),
            "fields": obj.get("fields"),
            "filters": ExportsGetResponseBodyParametersFilters.from_dict(obj.get("filters")) if obj.get("filters") is not None else None
        })
        return _obj
