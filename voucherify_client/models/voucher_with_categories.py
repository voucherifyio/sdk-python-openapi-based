...
class VoucherWithCategories(BaseModel):
    """
    This is an object representing a voucher with categories.  # noqa: E501
    """
    ...
    gift: Optional[VoucherWithCategoriesGift] = None
    loyalty_card: Optional[VoucherWithCategoriesLoyaltyCard] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VoucherWithCategories:
        """Create an instance of VoucherWithCategories from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VoucherWithCategories:
        """Create an instance of VoucherWithCategories from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VoucherWithCategories.parse_obj(obj)

        _obj = VoucherWithCategories.parse_obj({
            "id": obj.get("id"),
            "code": obj.get("code"),
            ...
            "gift": VoucherWithCategoriesGift.from_dict(obj.get("gift")) if obj.get("gift") is not None else None,
            "loyalty_card": VoucherWithCategoriesLoyaltyCard.from_dict(obj.get("loyalty_card")) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": VoucherWithCategoriesPublish.from_dict(obj.get("publish")) if obj.get("publish") is not None else None,
            "redemption": VoucherWithCategoriesRedemption.from_dict(obj.get("redemption")) if obj.get("redemption") is not None else None,
