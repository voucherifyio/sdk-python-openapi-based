...
class ExportRedemptionScheduled(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExportRedemptionScheduled:
        """Create an instance of ExportRedemptionScheduled from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExportRedemptionScheduled:
        """Create an instance of ExportRedemptionScheduled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExportRedemptionScheduled.parse_obj(obj)

        _obj = ExportRedemptionScheduled.parse_obj({
            "id": obj.get("id"),
