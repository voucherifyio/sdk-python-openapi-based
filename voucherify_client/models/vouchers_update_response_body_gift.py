...
class VouchersUpdateResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersUpdateResponseBodyGift:
        """Create an instance of VouchersUpdateResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersUpdateResponseBodyGift:
        """Create an instance of VouchersUpdateResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersUpdateResponseBodyGift.parse_obj(obj)

        _obj = VouchersUpdateResponseBodyGift.parse_obj({
