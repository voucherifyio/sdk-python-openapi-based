...
class VouchersDisableResponseBodyRedemption(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersDisableResponseBodyRedemption:
        """Create an instance of VouchersDisableResponseBodyRedemption from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersDisableResponseBodyRedemption:
        """Create an instance of VouchersDisableResponseBodyRedemption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersDisableResponseBodyRedemption.parse_obj(obj)

        _obj = VouchersDisableResponseBodyRedemption.parse_obj({
