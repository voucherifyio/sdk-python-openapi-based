...
class EventCustomerOrderPaid(BaseModel):
    """
    Event data object schema for `customer.order.paid`.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventCustomerOrderPaid:
        """Create an instance of EventCustomerOrderPaid from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventCustomerOrderPaid:
        """Create an instance of EventCustomerOrderPaid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventCustomerOrderPaid.parse_obj(obj)

        _obj = EventCustomerOrderPaid.parse_obj({
