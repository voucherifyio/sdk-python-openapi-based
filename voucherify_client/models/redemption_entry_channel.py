...
class RedemptionEntryChannel(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryChannel:
        """Create an instance of RedemptionEntryChannel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryChannel:
        """Create an instance of RedemptionEntryChannel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryChannel.parse_obj(obj)

        _obj = RedemptionEntryChannel.parse_obj({
