...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata:
        """Create an instance of LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata.parse_obj(obj)

        _obj = LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEventMetadata.parse_obj({
            "every": obj.get("every"),
