...
class LoyaltiesMembersRewardsListResponseBody(BaseModel):
    """
    Response body schema for **GET** `v1/loyalties/members/{memberId}/rewards`  # noqa: E501
    """
    object: Optional[StrictStr] = Field('list', description="The type of the object represented by JSON.")
    data_ref: Optional[StrictStr] = Field('data', description="Identifies the name of the attribute that contains the array of loyalty reward objects.")
    data: Optional[conlist(LoyaltiesMembersRewardsListResponseBodyDataItem)] = Field(None, description="Contains array of loyalty reward objects.")
    total: Optional[conint(strict=True, ge=0)] = Field(None, description="Total number of loyalty reward objects.")
