...
class RedemptionEntryPromotionTierCampaign(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RedemptionEntryPromotionTierCampaign:
        """Create an instance of RedemptionEntryPromotionTierCampaign from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RedemptionEntryPromotionTierCampaign:
        """Create an instance of RedemptionEntryPromotionTierCampaign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RedemptionEntryPromotionTierCampaign.parse_obj(obj)

        _obj = RedemptionEntryPromotionTierCampaign.parse_obj({
            "id": obj.get("id"),
