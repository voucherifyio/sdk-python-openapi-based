...
class VouchersGetResponseBodyGift(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VouchersGetResponseBodyGift:
        """Create an instance of VouchersGetResponseBodyGift from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VouchersGetResponseBodyGift:
        """Create an instance of VouchersGetResponseBodyGift from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VouchersGetResponseBodyGift.parse_obj(obj)

        _obj = VouchersGetResponseBodyGift.parse_obj({
