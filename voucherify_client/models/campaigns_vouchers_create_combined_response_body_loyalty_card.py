...
class CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard:
        """Create an instance of CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.parse_obj(obj)

        _obj = CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.parse_obj({
